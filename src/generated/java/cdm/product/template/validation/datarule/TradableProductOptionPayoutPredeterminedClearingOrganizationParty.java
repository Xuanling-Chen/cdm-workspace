...
public class TradableProductOptionPayoutPredeterminedClearingOrganizationParty implements Validator<TradableProduct> {
	
	private static final String NAME = "TradableProductOptionPayout_PredeterminedClearingOrganizationParty";
	private static final String DEFINITION = "if product -> contractualProduct -> economicTerms -> payout -> optionPayout -> settlementTerms -> physicalSettlementTerms -> predeterminedClearingOrganizationParty exists then ancillaryParty -> role contains AncillaryRoleEnum -> PredeterminedClearingOrganizationParty";
