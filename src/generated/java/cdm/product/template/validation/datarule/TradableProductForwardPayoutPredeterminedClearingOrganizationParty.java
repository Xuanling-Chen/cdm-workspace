...
public class TradableProductForwardPayoutPredeterminedClearingOrganizationParty implements Validator<TradableProduct> {
	
	private static final String NAME = "TradableProductForwardPayout_PredeterminedClearingOrganizationParty";
	private static final String DEFINITION = "if product -> contractualProduct -> economicTerms -> payout -> forwardPayout -> settlementTerms -> physicalSettlementTerms -> predeterminedClearingOrganizationParty exists then ancillaryParty -> role contains AncillaryRoleEnum -> PredeterminedClearingOrganizationParty";
