...
public class MandatoryEarlyTerminationOnlyExistsValidator implements ValidatorWithArg<MandatoryEarlyTermination, Set<String>> {
	...
	public <T2 extends MandatoryEarlyTermination> ValidationResult<MandatoryEarlyTermination> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("mandatoryEarlyTerminationDate", ExistenceChecker.isSet(o.getMandatoryEarlyTerminationDate()))
				...
				.put("mandatoryEarlyTerminationAdjustedDates", ExistenceChecker.isSet(o.getMandatoryEarlyTerminationAdjustedDates()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("MandatoryEarlyTermination", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("MandatoryEarlyTermination", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
