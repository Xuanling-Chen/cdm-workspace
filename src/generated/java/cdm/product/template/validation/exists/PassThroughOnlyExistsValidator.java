...
public class PassThroughOnlyExistsValidator implements ValidatorWithArg<PassThrough, Set<String>> {
	...
	public <T2 extends PassThrough> ValidationResult<PassThrough> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("passThroughItem", ExistenceChecker.isSet(o.getPassThroughItem()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("PassThrough", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("PassThrough", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
