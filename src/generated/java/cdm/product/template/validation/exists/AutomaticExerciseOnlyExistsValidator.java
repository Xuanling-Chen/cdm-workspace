...
public class AutomaticExerciseOnlyExistsValidator implements ValidatorWithArg<AutomaticExercise, Set<String>> {
	...
	public <T2 extends AutomaticExercise> ValidationResult<AutomaticExercise> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("thresholdRate", ExistenceChecker.isSet(o.getThresholdRate()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AutomaticExercise", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("AutomaticExercise", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
