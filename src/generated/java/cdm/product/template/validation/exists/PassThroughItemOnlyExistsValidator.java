...
public class PassThroughItemOnlyExistsValidator implements ValidatorWithArg<PassThroughItem, Set<String>> {
	...
	public <T2 extends PassThroughItem> ValidationResult<PassThroughItem> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("passThroughPercentage", ExistenceChecker.isSet(o.getPassThroughPercentage()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("PassThroughItem", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("PassThroughItem", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
