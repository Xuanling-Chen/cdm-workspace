...
public class CalendarSpreadOnlyExistsValidator implements ValidatorWithArg<CalendarSpread, Set<String>> {
	...
	public <T2 extends CalendarSpread> ValidationResult<CalendarSpread> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("expirationDateTwo", ExistenceChecker.isSet(o.getExpirationDateTwo()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CalendarSpread", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("CalendarSpread", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
