...
public class CollateralProvisionsOnlyExistsValidator implements ValidatorWithArg<CollateralProvisions, Set<String>> {
	...
	public <T2 extends CollateralProvisions> ValidationResult<CollateralProvisions> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("collateralType", ExistenceChecker.isSet(o.getCollateralType()))
				.put("marginPercentage", ExistenceChecker.isSet(o.getMarginPercentage()))
		...
		if (setFields.equals(fields)) {
			return success("CollateralProvisions", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("CollateralProvisions", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
