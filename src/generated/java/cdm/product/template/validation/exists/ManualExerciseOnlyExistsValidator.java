...
public class ManualExerciseOnlyExistsValidator implements ValidatorWithArg<ManualExercise, Set<String>> {
	...
	public <T2 extends ManualExercise> ValidationResult<ManualExercise> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("fallbackExercise", ExistenceChecker.isSet(o.getFallbackExercise()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ManualExercise", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ManualExercise", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
