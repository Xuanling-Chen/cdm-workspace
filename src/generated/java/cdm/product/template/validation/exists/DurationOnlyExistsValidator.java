...
public class DurationOnlyExistsValidator implements ValidatorWithArg<Duration, Set<String>> {
	...
	public <T2 extends Duration> ValidationResult<Duration> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("evergreenProvision", ExistenceChecker.isSet(o.getEvergreenProvision()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Duration", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("Duration", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
