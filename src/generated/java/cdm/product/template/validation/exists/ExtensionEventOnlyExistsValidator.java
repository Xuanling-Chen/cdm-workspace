...
public class ExtensionEventOnlyExistsValidator implements ValidatorWithArg<ExtensionEvent, Set<String>> {
	...
	public <T2 extends ExtensionEvent> ValidationResult<ExtensionEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("adjustedExtendedTerminationDate", ExistenceChecker.isSet(o.getAdjustedExtendedTerminationDate()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ExtensionEvent", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ExtensionEvent", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
