...
public class ExerciseFeeOnlyExistsValidator implements ValidatorWithArg<ExerciseFee, Set<String>> {
	...
	public <T2 extends ExerciseFee> ValidationResult<ExerciseFee> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("feeAmount", ExistenceChecker.isSet(o.getFeeAmount()))
				.put("feeRate", ExistenceChecker.isSet(o.getFeeRate()))
		...
		if (setFields.equals(fields)) {
			return success("ExerciseFee", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ExerciseFee", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
