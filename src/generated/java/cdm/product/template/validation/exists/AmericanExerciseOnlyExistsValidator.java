...
public class AmericanExerciseOnlyExistsValidator implements ValidatorWithArg<AmericanExercise, Set<String>> {
	...
	public <T2 extends AmericanExercise> ValidationResult<AmericanExercise> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("commencementDate", ExistenceChecker.isSet(o.getCommencementDate()))
		...
		if (setFields.equals(fields)) {
			return success("AmericanExercise", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("AmericanExercise", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
