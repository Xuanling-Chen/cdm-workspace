...
public class CancellationEventValidator implements Validator<CancellationEvent> {
	...
	public ValidationResult<CancellationEvent> validate(RosettaPath path, CancellationEvent o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CancellationEvent", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("CancellationEvent", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
