...
public class MandatoryEarlyTerminationAdjustedDatesValidator implements Validator<MandatoryEarlyTerminationAdjustedDates> {
	...
	public ValidationResult<MandatoryEarlyTerminationAdjustedDates> validate(RosettaPath path, MandatoryEarlyTerminationAdjustedDates o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("MandatoryEarlyTerminationAdjustedDates", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("MandatoryEarlyTerminationAdjustedDates", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
