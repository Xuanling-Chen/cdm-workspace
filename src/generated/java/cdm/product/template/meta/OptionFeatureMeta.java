...
public class OptionFeatureMeta implements RosettaMetaData<OptionFeature> {
	...
	@Override
	public List<Validator<? super OptionFeature>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super OptionFeature> validator() {
		return new cdm.product.template.validation.OptionFeatureValidator();
	}
	
	@Override
	public ValidatorWithArg<? super OptionFeature, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.OptionFeatureOnlyExistsValidator();
	}
}
