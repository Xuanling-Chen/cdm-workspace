...
public class CalculationAgentModelMeta implements RosettaMetaData<CalculationAgentModel> {
	...
	@Override
	public List<Validator<? super CalculationAgentModel>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CalculationAgentModel> validator() {
		return new cdm.product.template.validation.CalculationAgentModelValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CalculationAgentModel, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.CalculationAgentModelOnlyExistsValidator();
	}
}
