...
public class AutomaticExerciseMeta implements RosettaMetaData<AutomaticExercise> {
	...
	@Override
	public List<Validator<? super AutomaticExercise>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AutomaticExercise> validator() {
		return new cdm.product.template.validation.AutomaticExerciseValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AutomaticExercise, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.AutomaticExerciseOnlyExistsValidator();
	}
}
