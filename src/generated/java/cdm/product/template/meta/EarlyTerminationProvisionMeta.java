...
public class EarlyTerminationProvisionMeta implements RosettaMetaData<EarlyTerminationProvision> {
	...
	@Override
	public List<Validator<? super EarlyTerminationProvision>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super EarlyTerminationProvision> validator() {
		return new cdm.product.template.validation.EarlyTerminationProvisionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super EarlyTerminationProvision, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.EarlyTerminationProvisionOnlyExistsValidator();
	}
}
