...
public class QuantoMeta implements RosettaMetaData<Quanto> {
	...
	@Override
	public List<Validator<? super Quanto>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Quanto> validator() {
		return new cdm.product.template.validation.QuantoValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Quanto, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.QuantoOnlyExistsValidator();
	}
}
