...
public class BarrierMeta implements RosettaMetaData<Barrier> {
	...
	@Override
	public List<Validator<? super Barrier>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Barrier> validator() {
		return new cdm.product.template.validation.BarrierValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Barrier, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.BarrierOnlyExistsValidator();
	}
}
