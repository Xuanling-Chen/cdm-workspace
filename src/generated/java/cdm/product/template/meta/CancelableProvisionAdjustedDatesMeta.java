...
public class CancelableProvisionAdjustedDatesMeta implements RosettaMetaData<CancelableProvisionAdjustedDates> {
	...
	@Override
	public List<Validator<? super CancelableProvisionAdjustedDates>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CancelableProvisionAdjustedDates> validator() {
		return new cdm.product.template.validation.CancelableProvisionAdjustedDatesValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CancelableProvisionAdjustedDates, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.CancelableProvisionAdjustedDatesOnlyExistsValidator();
	}
}
