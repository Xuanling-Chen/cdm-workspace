...
public class DividendTermsMeta implements RosettaMetaData<DividendTerms> {
	...
	@Override
	public List<Validator<? super DividendTerms>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super DividendTerms> validator() {
		return new cdm.product.template.validation.DividendTermsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super DividendTerms, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.DividendTermsOnlyExistsValidator();
	}
}
