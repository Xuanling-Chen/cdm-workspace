...
public class PassThroughItemMeta implements RosettaMetaData<PassThroughItem> {
	...
	@Override
	public List<Validator<? super PassThroughItem>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PassThroughItem> validator() {
		return new cdm.product.template.validation.PassThroughItemValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PassThroughItem, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.PassThroughItemOnlyExistsValidator();
	}
}
