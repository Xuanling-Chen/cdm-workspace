...
public class CompositeMeta implements RosettaMetaData<Composite> {
	...
	@Override
	public List<Validator<? super Composite>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Composite> validator() {
		return new cdm.product.template.validation.CompositeValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Composite, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.CompositeOnlyExistsValidator();
	}
}
