...
public class PassThroughMeta implements RosettaMetaData<PassThrough> {
	...
	@Override
	public List<Validator<? super PassThrough>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PassThrough> validator() {
		return new cdm.product.template.validation.PassThroughValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PassThrough, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.PassThroughOnlyExistsValidator();
	}
}
