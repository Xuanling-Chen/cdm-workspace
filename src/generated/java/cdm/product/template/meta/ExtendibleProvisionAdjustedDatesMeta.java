...
public class ExtendibleProvisionAdjustedDatesMeta implements RosettaMetaData<ExtendibleProvisionAdjustedDates> {
	...
	@Override
	public List<Validator<? super ExtendibleProvisionAdjustedDates>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ExtendibleProvisionAdjustedDates> validator() {
		return new cdm.product.template.validation.ExtendibleProvisionAdjustedDatesValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ExtendibleProvisionAdjustedDates, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.ExtendibleProvisionAdjustedDatesOnlyExistsValidator();
	}
}
