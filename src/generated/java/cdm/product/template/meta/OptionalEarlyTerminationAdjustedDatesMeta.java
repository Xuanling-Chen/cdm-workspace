...
public class OptionalEarlyTerminationAdjustedDatesMeta implements RosettaMetaData<OptionalEarlyTerminationAdjustedDates> {
	...
	@Override
	public List<Validator<? super OptionalEarlyTerminationAdjustedDates>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super OptionalEarlyTerminationAdjustedDates> validator() {
		return new cdm.product.template.validation.OptionalEarlyTerminationAdjustedDatesValidator();
	}
	
	@Override
	public ValidatorWithArg<? super OptionalEarlyTerminationAdjustedDates, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.OptionalEarlyTerminationAdjustedDatesOnlyExistsValidator();
	}
}
