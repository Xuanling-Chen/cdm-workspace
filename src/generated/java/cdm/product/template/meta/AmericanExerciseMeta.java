...
public class AmericanExerciseMeta implements RosettaMetaData<AmericanExercise> {
	...
	@Override
	public List<Validator<? super AmericanExercise>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AmericanExercise> validator() {
		return new cdm.product.template.validation.AmericanExerciseValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AmericanExercise, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.AmericanExerciseOnlyExistsValidator();
	}
}
