...
public class EarlyTerminationEventMeta implements RosettaMetaData<EarlyTerminationEvent> {
	...
	@Override
	public List<Validator<? super EarlyTerminationEvent>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super EarlyTerminationEvent> validator() {
		return new cdm.product.template.validation.EarlyTerminationEventValidator();
	}
	
	@Override
	public ValidatorWithArg<? super EarlyTerminationEvent, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.EarlyTerminationEventOnlyExistsValidator();
	}
}
