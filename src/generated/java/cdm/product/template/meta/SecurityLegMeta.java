...
public class SecurityLegMeta implements RosettaMetaData<SecurityLeg> {
	...
	@Override
	public List<Validator<? super SecurityLeg>> choiceRuleValidators() {
		return Arrays.asList(
			new cdm.product.template.validation.choicerule.SecurityLegSecurityLegChoice()
		);
	}
	...
	public Validator<? super SecurityLeg> validator() {
		return new cdm.product.template.validation.SecurityLegValidator();
	}
	
	@Override
	public ValidatorWithArg<? super SecurityLeg, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.SecurityLegOnlyExistsValidator();
	}
}
