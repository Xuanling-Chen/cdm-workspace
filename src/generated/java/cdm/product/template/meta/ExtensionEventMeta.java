...
public class ExtensionEventMeta implements RosettaMetaData<ExtensionEvent> {
	...
	@Override
	public List<Validator<? super ExtensionEvent>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ExtensionEvent> validator() {
		return new cdm.product.template.validation.ExtensionEventValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ExtensionEvent, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.ExtensionEventOnlyExistsValidator();
	}
}
