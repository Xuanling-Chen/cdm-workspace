...
public class InitialMarginMeta implements RosettaMetaData<InitialMargin> {
	...
	@Override
	public List<Validator<? super InitialMargin>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super InitialMargin> validator() {
		return new cdm.product.template.validation.InitialMarginValidator();
	}
	
	@Override
	public ValidatorWithArg<? super InitialMargin, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.InitialMarginOnlyExistsValidator();
	}
}
