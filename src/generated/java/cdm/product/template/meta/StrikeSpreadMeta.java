...
public class StrikeSpreadMeta implements RosettaMetaData<StrikeSpread> {
	...
	@Override
	public List<Validator<? super StrikeSpread>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super StrikeSpread> validator() {
		return new cdm.product.template.validation.StrikeSpreadValidator();
	}
	
	@Override
	public ValidatorWithArg<? super StrikeSpread, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.StrikeSpreadOnlyExistsValidator();
	}
}
