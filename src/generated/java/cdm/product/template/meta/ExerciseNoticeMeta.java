...
public class ExerciseNoticeMeta implements RosettaMetaData<ExerciseNotice> {
	...
	@Override
	public List<Validator<? super ExerciseNotice>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ExerciseNotice> validator() {
		return new cdm.product.template.validation.ExerciseNoticeValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ExerciseNotice, Set<String>> onlyExistsValidator() {
		return new cdm.product.template.validation.exists.ExerciseNoticeOnlyExistsValidator();
	}
}
