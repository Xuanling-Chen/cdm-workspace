...
public class StubCalculationPeriodAmountMeta implements RosettaMetaData<StubCalculationPeriodAmount> {
	...
	@Override
	public List<Validator<? super StubCalculationPeriodAmount>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super StubCalculationPeriodAmount> validator() {
		return new cdm.product.common.schedule.validation.StubCalculationPeriodAmountValidator();
	}
	
	@Override
	public ValidatorWithArg<? super StubCalculationPeriodAmount, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.StubCalculationPeriodAmountOnlyExistsValidator();
	}
}
