...
public class ResetDatesMeta implements RosettaMetaData<ResetDates> {
	...
	@Override
	public List<Validator<? super ResetDates>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ResetDates> validator() {
		return new cdm.product.common.schedule.validation.ResetDatesValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ResetDates, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.ResetDatesOnlyExistsValidator();
	}
}
