...
public class AveragingObservationListMeta implements RosettaMetaData<AveragingObservationList> {
	...
	@Override
	public List<Validator<? super AveragingObservationList>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AveragingObservationList> validator() {
		return new cdm.product.common.schedule.validation.AveragingObservationListValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AveragingObservationList, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.AveragingObservationListOnlyExistsValidator();
	}
}
