...
public class FxLinkedNotionalScheduleMeta implements RosettaMetaData<FxLinkedNotionalSchedule> {
	...
	@Override
	public List<Validator<? super FxLinkedNotionalSchedule>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super FxLinkedNotionalSchedule> validator() {
		return new cdm.product.common.schedule.validation.FxLinkedNotionalScheduleValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FxLinkedNotionalSchedule, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.FxLinkedNotionalScheduleOnlyExistsValidator();
	}
}
