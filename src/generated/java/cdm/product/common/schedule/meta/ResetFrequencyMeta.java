...
public class ResetFrequencyMeta implements RosettaMetaData<ResetFrequency> {
	...
	@Override
	public List<Validator<? super ResetFrequency>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ResetFrequency> validator() {
		return new cdm.product.common.schedule.validation.ResetFrequencyValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ResetFrequency, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.ResetFrequencyOnlyExistsValidator();
	}
}
