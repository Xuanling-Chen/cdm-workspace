...
public class PaymentDateScheduleMeta implements RosettaMetaData<PaymentDateSchedule> {
	...
	@Override
	public List<Validator<? super PaymentDateSchedule>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PaymentDateSchedule> validator() {
		return new cdm.product.common.schedule.validation.PaymentDateScheduleValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PaymentDateSchedule, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.PaymentDateScheduleOnlyExistsValidator();
	}
}
