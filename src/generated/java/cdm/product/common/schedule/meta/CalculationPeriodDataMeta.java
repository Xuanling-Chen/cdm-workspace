...
public class CalculationPeriodDataMeta implements RosettaMetaData<CalculationPeriodData> {
	...
	@Override
	public List<Validator<? super CalculationPeriodData>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CalculationPeriodData> validator() {
		return new cdm.product.common.schedule.validation.CalculationPeriodDataValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CalculationPeriodData, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.CalculationPeriodDataOnlyExistsValidator();
	}
}
