...
public class CalculationPeriodDatesMeta implements RosettaMetaData<CalculationPeriodDates> {
	...
	@Override
	public List<Validator<? super CalculationPeriodDates>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CalculationPeriodDates> validator() {
		return new cdm.product.common.schedule.validation.CalculationPeriodDatesValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CalculationPeriodDates, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.CalculationPeriodDatesOnlyExistsValidator();
	}
}
