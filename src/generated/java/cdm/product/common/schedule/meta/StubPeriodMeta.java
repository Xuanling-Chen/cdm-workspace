...
public class StubPeriodMeta implements RosettaMetaData<StubPeriod> {
	...
	@Override
	public List<Validator<? super StubPeriod>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super StubPeriod> validator() {
		return new cdm.product.common.schedule.validation.StubPeriodValidator();
	}
	
	@Override
	public ValidatorWithArg<? super StubPeriod, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.StubPeriodOnlyExistsValidator();
	}
}
