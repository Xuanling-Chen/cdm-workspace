...
public class DateRelativeToCalculationPeriodDatesMeta implements RosettaMetaData<DateRelativeToCalculationPeriodDates> {
	...
	@Override
	public List<Validator<? super DateRelativeToCalculationPeriodDates>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super DateRelativeToCalculationPeriodDates> validator() {
		return new cdm.product.common.schedule.validation.DateRelativeToCalculationPeriodDatesValidator();
	}
	
	@Override
	public ValidatorWithArg<? super DateRelativeToCalculationPeriodDates, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.DateRelativeToCalculationPeriodDatesOnlyExistsValidator();
	}
}
