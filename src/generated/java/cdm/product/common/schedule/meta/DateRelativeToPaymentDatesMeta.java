...
public class DateRelativeToPaymentDatesMeta implements RosettaMetaData<DateRelativeToPaymentDates> {
	...
	@Override
	public List<Validator<? super DateRelativeToPaymentDates>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super DateRelativeToPaymentDates> validator() {
		return new cdm.product.common.schedule.validation.DateRelativeToPaymentDatesValidator();
	}
	
	@Override
	public ValidatorWithArg<? super DateRelativeToPaymentDates, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.DateRelativeToPaymentDatesOnlyExistsValidator();
	}
}
