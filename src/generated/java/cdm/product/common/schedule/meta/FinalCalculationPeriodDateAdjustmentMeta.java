...
public class FinalCalculationPeriodDateAdjustmentMeta implements RosettaMetaData<FinalCalculationPeriodDateAdjustment> {
	...
	@Override
	public List<Validator<? super FinalCalculationPeriodDateAdjustment>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super FinalCalculationPeriodDateAdjustment> validator() {
		return new cdm.product.common.schedule.validation.FinalCalculationPeriodDateAdjustmentValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FinalCalculationPeriodDateAdjustment, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.FinalCalculationPeriodDateAdjustmentOnlyExistsValidator();
	}
}
