...
public class AmountScheduleMeta implements RosettaMetaData<AmountSchedule> {
	...
	@Override
	public List<Validator<? super AmountSchedule>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AmountSchedule> validator() {
		return new cdm.product.common.schedule.validation.AmountScheduleValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AmountSchedule, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.schedule.validation.exists.AmountScheduleOnlyExistsValidator();
	}
}
