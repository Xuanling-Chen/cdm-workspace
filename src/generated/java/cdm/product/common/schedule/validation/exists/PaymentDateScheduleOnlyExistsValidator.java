...
public class PaymentDateScheduleOnlyExistsValidator implements ValidatorWithArg<PaymentDateSchedule, Set<String>> {
	...
	public <T2 extends PaymentDateSchedule> ValidationResult<PaymentDateSchedule> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("interimPaymentDates", ExistenceChecker.isSet(o.getInterimPaymentDates()))
				.put("finalPaymentDate", ExistenceChecker.isSet(o.getFinalPaymentDate()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("PaymentDateSchedule", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("PaymentDateSchedule", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
