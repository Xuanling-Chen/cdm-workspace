...
public class ResetFrequencyOnlyExistsValidator implements ValidatorWithArg<ResetFrequency, Set<String>> {
	...
	public <T2 extends ResetFrequency> ValidationResult<ResetFrequency> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("weeklyRollConvention", ExistenceChecker.isSet(o.getWeeklyRollConvention()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ResetFrequency", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ResetFrequency", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
