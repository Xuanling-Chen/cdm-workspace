...
@ImplementedBy(Qualify_CreditDefaultSwap_Loan.Qualify_CreditDefaultSwap_LoanDefault.class)
public abstract class Qualify_CreditDefaultSwap_Loan implements RosettaFunction, IQualifyFunctionExtension<EconomicTerms> {
	...
	*/
	...
	public static final class Qualify_CreditDefaultSwap_LoanDefault extends Qualify_CreditDefaultSwap_Loan {
		@Override
