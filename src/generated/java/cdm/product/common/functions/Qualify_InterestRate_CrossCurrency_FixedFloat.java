...
@ImplementedBy(Qualify_InterestRate_CrossCurrency_FixedFloat.Qualify_InterestRate_CrossCurrency_FixedFloatDefault.class)
public abstract class Qualify_InterestRate_CrossCurrency_FixedFloat implements RosettaFunction, IQualifyFunctionExtension<EconomicTerms> {
	...
	*/
	...
	public static final class Qualify_InterestRate_CrossCurrency_FixedFloatDefault extends Qualify_InterestRate_CrossCurrency_FixedFloat {
		@Override
