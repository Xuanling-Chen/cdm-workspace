...
@ImplementedBy(Qualify_InterestRate_IRSwap_Basis.Qualify_InterestRate_IRSwap_BasisDefault.class)
public abstract class Qualify_InterestRate_IRSwap_Basis implements RosettaFunction, IQualifyFunctionExtension<EconomicTerms> {
	...
	*/
	...
	public static final class Qualify_InterestRate_IRSwap_BasisDefault extends Qualify_InterestRate_IRSwap_Basis {
		@Override
