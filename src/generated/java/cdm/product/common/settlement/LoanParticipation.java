...
public interface LoanParticipation extends PCDeliverableObligationCharac {
	...
	final static LoanParticipationMeta metaData = new LoanParticipationMeta();
	...
	default void process(RosettaPath path, Processor processor) {
		cdm.product.common.settlement.PCDeliverableObligationCharac.super.process(path, processor);
	...
	interface LoanParticipationBuilder extends LoanParticipation, PCDeliverableObligationCharac.PCDeliverableObligationCharacBuilder, RosettaModelObjectBuilder {
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			PCDeliverableObligationCharac.PCDeliverableObligationCharacBuilder.super.process(path, processor);
