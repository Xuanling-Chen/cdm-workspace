...
public class SettlementDateOnlyExistsValidator implements ValidatorWithArg<SettlementDate, Set<String>> {
	...
	public <T2 extends SettlementDate> ValidationResult<SettlementDate> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("businessDateRange", ExistenceChecker.isSet(o.getBusinessDateRange()))
				.put("cashSettlementBusinessDays", ExistenceChecker.isSet(o.getCashSettlementBusinessDays()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("SettlementDate", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("SettlementDate", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
