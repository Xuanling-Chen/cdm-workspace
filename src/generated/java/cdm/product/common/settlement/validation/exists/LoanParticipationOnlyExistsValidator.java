...
public class LoanParticipationOnlyExistsValidator implements ValidatorWithArg<LoanParticipation, Set<String>> {
	...
	public <T2 extends LoanParticipation> ValidationResult<LoanParticipation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("qualifyingParticipationSeller", ExistenceChecker.isSet(o.getQualifyingParticipationSeller()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("LoanParticipation", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("LoanParticipation", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
