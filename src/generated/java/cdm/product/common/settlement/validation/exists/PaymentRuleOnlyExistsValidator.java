...
public class PaymentRuleOnlyExistsValidator implements ValidatorWithArg<PaymentRule, Set<String>> {
	...
	public <T2 extends PaymentRule> ValidationResult<PaymentRule> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("percentageRule", ExistenceChecker.isSet(o.getPercentageRule()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("PaymentRule", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("PaymentRule", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
