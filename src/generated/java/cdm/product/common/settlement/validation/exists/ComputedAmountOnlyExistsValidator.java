...
public class ComputedAmountOnlyExistsValidator implements ValidatorWithArg<ComputedAmount, Set<String>> {
	...
	public <T2 extends ComputedAmount> ValidationResult<ComputedAmount> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("callFunction", ExistenceChecker.isSet(o.getCallFunction()))
		...
		if (setFields.equals(fields)) {
			return success("ComputedAmount", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ComputedAmount", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
