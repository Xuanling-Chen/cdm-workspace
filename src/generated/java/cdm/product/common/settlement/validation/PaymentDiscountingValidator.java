...
public class PaymentDiscountingValidator implements Validator<PaymentDiscounting> {
	...
	public ValidationResult<PaymentDiscounting> validate(RosettaPath path, PaymentDiscounting o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("PaymentDiscounting", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("PaymentDiscounting", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
