...
public class RollFeatureMeta implements RosettaMetaData<RollFeature> {
	...
	@Override
	public List<Validator<? super RollFeature>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super RollFeature> validator() {
		return new cdm.product.common.settlement.validation.RollFeatureValidator();
	}
	
	@Override
	public ValidatorWithArg<? super RollFeature, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.settlement.validation.exists.RollFeatureOnlyExistsValidator();
	}
}
