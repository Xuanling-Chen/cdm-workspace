...
public class PaymentDiscountingMeta implements RosettaMetaData<PaymentDiscounting> {
	...
	@Override
	public List<Validator<? super PaymentDiscounting>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PaymentDiscounting> validator() {
		return new cdm.product.common.settlement.validation.PaymentDiscountingValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PaymentDiscounting, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.settlement.validation.exists.PaymentDiscountingOnlyExistsValidator();
	}
}
