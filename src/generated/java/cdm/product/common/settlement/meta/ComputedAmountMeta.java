...
public class ComputedAmountMeta implements RosettaMetaData<ComputedAmount> {
	...
	@Override
	public List<Validator<? super ComputedAmount>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ComputedAmount> validator() {
		return new cdm.product.common.settlement.validation.ComputedAmountValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ComputedAmount, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.settlement.validation.exists.ComputedAmountOnlyExistsValidator();
	}
}
