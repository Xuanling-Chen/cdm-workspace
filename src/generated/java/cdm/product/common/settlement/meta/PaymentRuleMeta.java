...
public class PaymentRuleMeta implements RosettaMetaData<PaymentRule> {
	...
	@Override
	public List<Validator<? super PaymentRule>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PaymentRule> validator() {
		return new cdm.product.common.settlement.validation.PaymentRuleValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PaymentRule, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.settlement.validation.exists.PaymentRuleOnlyExistsValidator();
	}
}
