...
public class PercentageRuleMeta implements RosettaMetaData<PercentageRule> {
	...
	@Override
	public List<Validator<? super PercentageRule>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PercentageRule> validator() {
		return new cdm.product.common.settlement.validation.PercentageRuleValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PercentageRule, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.settlement.validation.exists.PercentageRuleOnlyExistsValidator();
	}
}
