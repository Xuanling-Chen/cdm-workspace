...
public class PaymentDetailMeta implements RosettaMetaData<PaymentDetail> {
	...
	@Override
	public List<Validator<? super PaymentDetail>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PaymentDetail> validator() {
		return new cdm.product.common.settlement.validation.PaymentDetailValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PaymentDetail, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.settlement.validation.exists.PaymentDetailOnlyExistsValidator();
	}
}
