...
public class PhysicalSettlementTermsMeta implements RosettaMetaData<PhysicalSettlementTerms> {
	...
	@Override
	public List<Validator<? super PhysicalSettlementTerms>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PhysicalSettlementTerms> validator() {
		return new cdm.product.common.settlement.validation.PhysicalSettlementTermsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PhysicalSettlementTerms, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.settlement.validation.exists.PhysicalSettlementTermsOnlyExistsValidator();
	}
}
