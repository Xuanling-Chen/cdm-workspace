...
public class PhysicalSettlementPeriodMeta implements RosettaMetaData<PhysicalSettlementPeriod> {
	...
	@Override
	public List<Validator<? super PhysicalSettlementPeriod>> choiceRuleValidators() {
		return Arrays.asList(
			new cdm.product.common.settlement.validation.choicerule.PhysicalSettlementPeriodOneOf0()
		);
	}
	...
	public Validator<? super PhysicalSettlementPeriod> validator() {
		return new cdm.product.common.settlement.validation.PhysicalSettlementPeriodValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PhysicalSettlementPeriod, Set<String>> onlyExistsValidator() {
		return new cdm.product.common.settlement.validation.exists.PhysicalSettlementPeriodOnlyExistsValidator();
	}
}
