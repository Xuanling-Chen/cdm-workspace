...
public class ForeignExchangeMeta implements RosettaMetaData<ForeignExchange> {
	...
	@Override
	public List<Validator<? super ForeignExchange>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ForeignExchange> validator() {
		return new cdm.product.asset.validation.ForeignExchangeValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ForeignExchange, Set<String>> onlyExistsValidator() {
		return new cdm.product.asset.validation.exists.ForeignExchangeOnlyExistsValidator();
	}
}
