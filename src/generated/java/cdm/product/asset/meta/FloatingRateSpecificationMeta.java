...
public class FloatingRateSpecificationMeta implements RosettaMetaData<FloatingRateSpecification> {
	...
	@Override
	public List<Validator<? super FloatingRateSpecification>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super FloatingRateSpecification> validator() {
		return new cdm.product.asset.validation.FloatingRateSpecificationValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FloatingRateSpecification, Set<String>> onlyExistsValidator() {
		return new cdm.product.asset.validation.exists.FloatingRateSpecificationOnlyExistsValidator();
	}
}
