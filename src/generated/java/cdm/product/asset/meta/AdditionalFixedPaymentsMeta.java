...
public class AdditionalFixedPaymentsMeta implements RosettaMetaData<AdditionalFixedPayments> {
	...
	@Override
	public List<Validator<? super AdditionalFixedPayments>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AdditionalFixedPayments> validator() {
		return new cdm.product.asset.validation.AdditionalFixedPaymentsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AdditionalFixedPayments, Set<String>> onlyExistsValidator() {
		return new cdm.product.asset.validation.exists.AdditionalFixedPaymentsOnlyExistsValidator();
	}
}
