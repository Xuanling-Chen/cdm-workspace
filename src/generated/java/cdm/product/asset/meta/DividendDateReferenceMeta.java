...
public class DividendDateReferenceMeta implements RosettaMetaData<DividendDateReference> {
	...
	@Override
	public List<Validator<? super DividendDateReference>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super DividendDateReference> validator() {
		return new cdm.product.asset.validation.DividendDateReferenceValidator();
	}
	
	@Override
	public ValidatorWithArg<? super DividendDateReference, Set<String>> onlyExistsValidator() {
		return new cdm.product.asset.validation.exists.DividendDateReferenceOnlyExistsValidator();
	}
}
