...
public class InterestShortFallMeta implements RosettaMetaData<InterestShortFall> {
	...
	@Override
	public List<Validator<? super InterestShortFall>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super InterestShortFall> validator() {
		return new cdm.product.asset.validation.InterestShortFallValidator();
	}
	
	@Override
	public ValidatorWithArg<? super InterestShortFall, Set<String>> onlyExistsValidator() {
		return new cdm.product.asset.validation.exists.InterestShortFallOnlyExistsValidator();
	}
}
