...
public class BondReferenceMeta implements RosettaMetaData<BondReference> {
	...
	@Override
	public List<Validator<? super BondReference>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super BondReference> validator() {
		return new cdm.product.asset.validation.BondReferenceValidator();
	}
	
	@Override
	public ValidatorWithArg<? super BondReference, Set<String>> onlyExistsValidator() {
		return new cdm.product.asset.validation.exists.BondReferenceOnlyExistsValidator();
	}
}
