...
public class FloatingRateDefinitionMeta implements RosettaMetaData<FloatingRateDefinition> {
	...
	@Override
	public List<Validator<? super FloatingRateDefinition>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super FloatingRateDefinition> validator() {
		return new cdm.product.asset.validation.FloatingRateDefinitionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FloatingRateDefinition, Set<String>> onlyExistsValidator() {
		return new cdm.product.asset.validation.exists.FloatingRateDefinitionOnlyExistsValidator();
	}
}
