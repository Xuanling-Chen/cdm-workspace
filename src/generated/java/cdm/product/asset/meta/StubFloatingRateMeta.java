...
public class StubFloatingRateMeta implements RosettaMetaData<StubFloatingRate> {
	...
	@Override
	public List<Validator<? super StubFloatingRate>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super StubFloatingRate> validator() {
		return new cdm.product.asset.validation.StubFloatingRateValidator();
	}
	
	@Override
	public ValidatorWithArg<? super StubFloatingRate, Set<String>> onlyExistsValidator() {
		return new cdm.product.asset.validation.exists.StubFloatingRateOnlyExistsValidator();
	}
}
