...
public class StubValueOnlyExistsValidator implements ValidatorWithArg<StubValue, Set<String>> {
	...
	public <T2 extends StubValue> ValidationResult<StubValue> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("stubRate", ExistenceChecker.isSet(o.getStubRate()))
				.put("stubAmount", ExistenceChecker.isSet(o.getStubAmount()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("StubValue", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("StubValue", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
