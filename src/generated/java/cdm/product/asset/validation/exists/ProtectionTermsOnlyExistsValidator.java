...
public class ProtectionTermsOnlyExistsValidator implements ValidatorWithArg<ProtectionTerms, Set<String>> {
	...
	public <T2 extends ProtectionTerms> ValidationResult<ProtectionTerms> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("obligations", ExistenceChecker.isSet(o.getObligations()))
				.put("floatingAmountEvents", ExistenceChecker.isSet(o.getFloatingAmountEvents()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ProtectionTerms", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ProtectionTerms", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
