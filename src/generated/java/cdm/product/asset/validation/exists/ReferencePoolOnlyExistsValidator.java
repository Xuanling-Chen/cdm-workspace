...
public class ReferencePoolOnlyExistsValidator implements ValidatorWithArg<ReferencePool, Set<String>> {
	...
	public <T2 extends ReferencePool> ValidationResult<ReferencePool> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("referencePoolItem", ExistenceChecker.isSet(o.getReferencePoolItem()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ReferencePool", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ReferencePool", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
