...
public class ReferencePoolFpMLCd44BasketPercentage implements Validator<ReferencePool> {
	
	private static final String NAME = "ReferencePoolFpML_cd_44_basketPercentage";
	private static final String DEFINITION = "if referencePoolItem -> constituentWeight -> basketPercentage exists then referencePoolItem -> constituentWeight -> openUnits is absent";
