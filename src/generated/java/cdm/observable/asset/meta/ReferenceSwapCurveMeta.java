...
public class ReferenceSwapCurveMeta implements RosettaMetaData<ReferenceSwapCurve> {
	...
	@Override
	public List<Validator<? super ReferenceSwapCurve>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ReferenceSwapCurve> validator() {
		return new cdm.observable.asset.validation.ReferenceSwapCurveValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ReferenceSwapCurve, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.ReferenceSwapCurveOnlyExistsValidator();
	}
}
