...
public class CreditNotationMeta implements RosettaMetaData<CreditNotation> {
	...
	@Override
	public List<Validator<? super CreditNotation>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CreditNotation> validator() {
		return new cdm.observable.asset.validation.CreditNotationValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CreditNotation, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.CreditNotationOnlyExistsValidator();
	}
}
