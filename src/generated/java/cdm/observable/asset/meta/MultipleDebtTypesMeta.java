...
public class MultipleDebtTypesMeta implements RosettaMetaData<MultipleDebtTypes> {
	...
	@Override
	public List<Validator<? super MultipleDebtTypes>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super MultipleDebtTypes> validator() {
		return new cdm.observable.asset.validation.MultipleDebtTypesValidator();
	}
	
	@Override
	public ValidatorWithArg<? super MultipleDebtTypes, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.MultipleDebtTypesOnlyExistsValidator();
	}
}
