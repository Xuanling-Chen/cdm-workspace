...
public class ObservationSourceMeta implements RosettaMetaData<ObservationSource> {
	...
	@Override
	public List<Validator<? super ObservationSource>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ObservationSource> validator() {
		return new cdm.observable.asset.validation.ObservationSourceValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ObservationSource, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.ObservationSourceOnlyExistsValidator();
	}
}
