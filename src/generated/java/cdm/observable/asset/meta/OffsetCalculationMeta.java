...
public class OffsetCalculationMeta implements RosettaMetaData<OffsetCalculation> {
	...
	@Override
	public List<Validator<? super OffsetCalculation>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super OffsetCalculation> validator() {
		return new cdm.observable.asset.validation.OffsetCalculationValidator();
	}
	
	@Override
	public ValidatorWithArg<? super OffsetCalculation, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.OffsetCalculationOnlyExistsValidator();
	}
}
