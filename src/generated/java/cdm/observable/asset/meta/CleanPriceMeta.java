...
public class CleanPriceMeta implements RosettaMetaData<CleanPrice> {
	...
	@Override
	public List<Validator<? super CleanPrice>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CleanPrice> validator() {
		return new cdm.observable.asset.validation.CleanPriceValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CleanPrice, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.CleanPriceOnlyExistsValidator();
	}
}
