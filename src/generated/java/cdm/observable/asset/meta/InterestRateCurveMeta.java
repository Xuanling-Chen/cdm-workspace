...
public class InterestRateCurveMeta implements RosettaMetaData<InterestRateCurve> {
	...
	@Override
	public List<Validator<? super InterestRateCurve>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super InterestRateCurve> validator() {
		return new cdm.observable.asset.validation.InterestRateCurveValidator();
	}
	
	@Override
	public ValidatorWithArg<? super InterestRateCurve, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.InterestRateCurveOnlyExistsValidator();
	}
}
