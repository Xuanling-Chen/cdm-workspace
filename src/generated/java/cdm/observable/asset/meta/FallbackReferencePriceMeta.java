...
public class FallbackReferencePriceMeta implements RosettaMetaData<FallbackReferencePrice> {
	...
	@Override
	public List<Validator<? super FallbackReferencePrice>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super FallbackReferencePrice> validator() {
		return new cdm.observable.asset.validation.FallbackReferencePriceValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FallbackReferencePrice, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.FallbackReferencePriceOnlyExistsValidator();
	}
}
