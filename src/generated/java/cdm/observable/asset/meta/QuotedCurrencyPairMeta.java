...
public class QuotedCurrencyPairMeta implements RosettaMetaData<QuotedCurrencyPair> {
	...
	@Override
	public List<Validator<? super QuotedCurrencyPair>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super QuotedCurrencyPair> validator() {
		return new cdm.observable.asset.validation.QuotedCurrencyPairValidator();
	}
	
	@Override
	public ValidatorWithArg<? super QuotedCurrencyPair, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.QuotedCurrencyPairOnlyExistsValidator();
	}
}
