...
public class ValuationMethodMeta implements RosettaMetaData<ValuationMethod> {
	...
	@Override
	public List<Validator<? super ValuationMethod>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ValuationMethod> validator() {
		return new cdm.observable.asset.validation.ValuationMethodValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ValuationMethod, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.ValuationMethodOnlyExistsValidator();
	}
}
