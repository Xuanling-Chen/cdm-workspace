...
public class RelativePriceMeta implements RosettaMetaData<RelativePrice> {
	...
	@Override
	public List<Validator<? super RelativePrice>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super RelativePrice> validator() {
		return new cdm.observable.asset.validation.RelativePriceValidator();
	}
	
	@Override
	public ValidatorWithArg<? super RelativePrice, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.RelativePriceOnlyExistsValidator();
	}
}
