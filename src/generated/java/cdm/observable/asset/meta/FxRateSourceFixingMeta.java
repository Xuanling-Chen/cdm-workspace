...
public class FxRateSourceFixingMeta implements RosettaMetaData<FxRateSourceFixing> {
	...
	@Override
	public List<Validator<? super FxRateSourceFixing>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super FxRateSourceFixing> validator() {
		return new cdm.observable.asset.validation.FxRateSourceFixingValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FxRateSourceFixing, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.FxRateSourceFixingOnlyExistsValidator();
	}
}
