...
public class BondChoiceModelMeta implements RosettaMetaData<BondChoiceModel> {
	...
	@Override
	public List<Validator<? super BondChoiceModel>> choiceRuleValidators() {
		return Arrays.asList(
			new cdm.observable.asset.validation.choicerule.BondChoiceModelOneOf0()
		);
	}
	...
	public Validator<? super BondChoiceModel> validator() {
		return new cdm.observable.asset.validation.BondChoiceModelValidator();
	}
	
	@Override
	public ValidatorWithArg<? super BondChoiceModel, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.BondChoiceModelOnlyExistsValidator();
	}
}
