...
public class CleanOrDirtyPriceMeta implements RosettaMetaData<CleanOrDirtyPrice> {
	...
	@Override
	public List<Validator<? super CleanOrDirtyPrice>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CleanOrDirtyPrice> validator() {
		return new cdm.observable.asset.validation.CleanOrDirtyPriceValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CleanOrDirtyPrice, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.CleanOrDirtyPriceOnlyExistsValidator();
	}
}
