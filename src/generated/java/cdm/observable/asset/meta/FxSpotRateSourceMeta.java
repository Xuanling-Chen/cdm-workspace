...
public class FxSpotRateSourceMeta implements RosettaMetaData<FxSpotRateSource> {
	...
	@Override
	public List<Validator<? super FxSpotRateSource>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super FxSpotRateSource> validator() {
		return new cdm.observable.asset.validation.FxSpotRateSourceValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FxSpotRateSource, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.FxSpotRateSourceOnlyExistsValidator();
	}
}
