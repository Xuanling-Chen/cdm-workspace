...
public class PriceSourceDisruptionMeta implements RosettaMetaData<PriceSourceDisruption> {
	...
	@Override
	public List<Validator<? super PriceSourceDisruption>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PriceSourceDisruption> validator() {
		return new cdm.observable.asset.validation.PriceSourceDisruptionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PriceSourceDisruption, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.PriceSourceDisruptionOnlyExistsValidator();
	}
}
