...
public class SingleValuationDateMeta implements RosettaMetaData<SingleValuationDate> {
	...
	@Override
	public List<Validator<? super SingleValuationDate>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super SingleValuationDate> validator() {
		return new cdm.observable.asset.validation.SingleValuationDateValidator();
	}
	
	@Override
	public ValidatorWithArg<? super SingleValuationDate, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.SingleValuationDateOnlyExistsValidator();
	}
}
