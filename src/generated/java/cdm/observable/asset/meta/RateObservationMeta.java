...
public class RateObservationMeta implements RosettaMetaData<RateObservation> {
	...
	@Override
	public List<Validator<? super RateObservation>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super RateObservation> validator() {
		return new cdm.observable.asset.validation.RateObservationValidator();
	}
	
	@Override
	public ValidatorWithArg<? super RateObservation, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.RateObservationOnlyExistsValidator();
	}
}
