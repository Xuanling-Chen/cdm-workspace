...
public class ValuationPostponementMeta implements RosettaMetaData<ValuationPostponement> {
	...
	@Override
	public List<Validator<? super ValuationPostponement>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ValuationPostponement> validator() {
		return new cdm.observable.asset.validation.ValuationPostponementValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ValuationPostponement, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.ValuationPostponementOnlyExistsValidator();
	}
}
