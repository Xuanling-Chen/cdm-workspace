...
public class SecurityValuationMeta implements RosettaMetaData<SecurityValuation> {
	...
	@Override
	public List<Validator<? super SecurityValuation>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super SecurityValuation> validator() {
		return new cdm.observable.asset.validation.SecurityValuationValidator();
	}
	
	@Override
	public ValidatorWithArg<? super SecurityValuation, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.SecurityValuationOnlyExistsValidator();
	}
}
