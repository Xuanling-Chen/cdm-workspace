...
public class MultipleCreditNotationsMeta implements RosettaMetaData<MultipleCreditNotations> {
	...
	@Override
	public List<Validator<? super MultipleCreditNotations>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super MultipleCreditNotations> validator() {
		return new cdm.observable.asset.validation.MultipleCreditNotationsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super MultipleCreditNotations, Set<String>> onlyExistsValidator() {
		return new cdm.observable.asset.validation.exists.MultipleCreditNotationsOnlyExistsValidator();
	}
}
