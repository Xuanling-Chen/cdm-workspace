...
public class FxInformationSourceValidator implements Validator<FxInformationSource> {
	...
	public ValidationResult<FxInformationSource> validate(RosettaPath path, FxInformationSource o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FxInformationSource", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("FxInformationSource", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
