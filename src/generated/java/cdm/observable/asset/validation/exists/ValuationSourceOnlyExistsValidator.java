...
public class ValuationSourceOnlyExistsValidator implements ValidatorWithArg<ValuationSource, Set<String>> {
	...
	public <T2 extends ValuationSource> ValidationResult<ValuationSource> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("referenceBanks", ExistenceChecker.isSet(o.getReferenceBanks()))
				.put("dealerOrCCP", ExistenceChecker.isSet(o.getDealerOrCCP()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ValuationSource", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ValuationSource", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
