...
public class InterestRateCurveOnlyExistsValidator implements ValidatorWithArg<InterestRateCurve, Set<String>> {
	...
	public <T2 extends InterestRateCurve> ValidationResult<InterestRateCurve> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("tenor", ExistenceChecker.isSet(o.getTenor()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("InterestRateCurve", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("InterestRateCurve", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
