...
public class CreditRatingDebtOnlyExistsValidator implements ValidatorWithArg<CreditRatingDebt, Set<String>> {
	...
	public <T2 extends CreditRatingDebt> ValidationResult<CreditRatingDebt> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("debtTypes", ExistenceChecker.isSet(o.getDebtTypes()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CreditRatingDebt", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("CreditRatingDebt", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
