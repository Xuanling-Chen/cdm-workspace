...
public class ValuationPostponementOnlyExistsValidator implements ValidatorWithArg<ValuationPostponement, Set<String>> {
	...
	public <T2 extends ValuationPostponement> ValidationResult<ValuationPostponement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("maximumDaysOfPostponement", ExistenceChecker.isSet(o.getMaximumDaysOfPostponement()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ValuationPostponement", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ValuationPostponement", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
