...
public class CreditNotationsOnlyExistsValidator implements ValidatorWithArg<CreditNotations, Set<String>> {
	...
	public <T2 extends CreditNotations> ValidationResult<CreditNotations> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("creditNotations", ExistenceChecker.isSet(o.getCreditNotations()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CreditNotations", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("CreditNotations", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
