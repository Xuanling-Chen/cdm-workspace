...
public class ObservableOnlyExistsValidator implements ValidatorWithArg<Observable, Set<String>> {
	...
	public <T2 extends Observable> ValidationResult<Observable> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("currencyPair", ExistenceChecker.isSet(o.getCurrencyPair()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Observable", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("Observable", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
