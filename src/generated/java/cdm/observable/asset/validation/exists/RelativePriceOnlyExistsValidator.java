...
public class RelativePriceOnlyExistsValidator implements ValidatorWithArg<RelativePrice, Set<String>> {
	...
	public <T2 extends RelativePrice> ValidationResult<RelativePrice> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("bondEquityModel", ExistenceChecker.isSet(o.getBondEquityModel()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("RelativePrice", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("RelativePrice", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
