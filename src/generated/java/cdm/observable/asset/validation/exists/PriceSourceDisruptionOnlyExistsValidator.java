...
public class PriceSourceDisruptionOnlyExistsValidator implements ValidatorWithArg<PriceSourceDisruption, Set<String>> {
	...
	public <T2 extends PriceSourceDisruption> ValidationResult<PriceSourceDisruption> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("fallbackReferencePrice", ExistenceChecker.isSet(o.getFallbackReferencePrice()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("PriceSourceDisruption", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("PriceSourceDisruption", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
