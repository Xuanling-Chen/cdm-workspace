...
public class UnitContractValuationModelOnlyExistsValidator implements ValidatorWithArg<UnitContractValuationModel, Set<String>> {
	...
	public <T2 extends UnitContractValuationModel> ValidationResult<UnitContractValuationModel> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("numberOfUnits", ExistenceChecker.isSet(o.getNumberOfUnits()))
				.put("unitPrice", ExistenceChecker.isSet(o.getUnitPrice()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("UnitContractValuationModel", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("UnitContractValuationModel", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
