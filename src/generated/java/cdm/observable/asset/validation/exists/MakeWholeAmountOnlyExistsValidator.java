...
public class MakeWholeAmountOnlyExistsValidator implements ValidatorWithArg<MakeWholeAmount, Set<String>> {
	...
	public <T2 extends MakeWholeAmount> ValidationResult<MakeWholeAmount> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("earlyCallDate", ExistenceChecker.isSet(o.getEarlyCallDate()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("MakeWholeAmount", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("MakeWholeAmount", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
