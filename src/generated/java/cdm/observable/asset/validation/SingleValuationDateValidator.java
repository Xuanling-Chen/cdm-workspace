...
public class SingleValuationDateValidator implements Validator<SingleValuationDate> {
	...
	public ValidationResult<SingleValuationDate> validate(RosettaPath path, SingleValuationDate o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("SingleValuationDate", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("SingleValuationDate", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
