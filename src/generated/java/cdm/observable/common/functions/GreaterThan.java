...
@ImplementedBy(GreaterThan.GreaterThanDefault.class)
public abstract class GreaterThan implements RosettaFunction {
	...
	*/
	...
	public static final class GreaterThanDefault extends GreaterThan {
		@Override
