...
public class FailureToPayOnlyExistsValidator implements ValidatorWithArg<FailureToPay, Set<String>> {
	...
	public <T2 extends FailureToPay> ValidationResult<FailureToPay> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("gracePeriodExtension", ExistenceChecker.isSet(o.getGracePeriodExtension()))
				.put("paymentRequirement", ExistenceChecker.isSet(o.getPaymentRequirement()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("FailureToPay", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("FailureToPay", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
