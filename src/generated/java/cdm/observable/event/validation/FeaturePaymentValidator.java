	...
	public ValidationResult<FeaturePayment> validate(RosettaPath path, FeaturePayment o) {
		String error = 
			Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("time", o.getTime()!=null ? 1 : 0, 0, 1),
		...
		if (!isNullOrEmpty(error)) {
			return failure("FeaturePayment", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("FeaturePayment", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
