...
public class DeterminationMethodologyValidator implements Validator<DeterminationMethodology> {
	...
	public ValidationResult<DeterminationMethodology> validate(RosettaPath path, DeterminationMethodology o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("DeterminationMethodology", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("DeterminationMethodology", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
