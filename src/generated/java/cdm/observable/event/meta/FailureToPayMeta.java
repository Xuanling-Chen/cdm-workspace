...
public class FailureToPayMeta implements RosettaMetaData<FailureToPay> {
	...
	@Override
	public List<Validator<? super FailureToPay>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super FailureToPay> validator() {
		return new cdm.observable.event.validation.FailureToPayValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FailureToPay, Set<String>> onlyExistsValidator() {
		return new cdm.observable.event.validation.exists.FailureToPayOnlyExistsValidator();
	}
}
