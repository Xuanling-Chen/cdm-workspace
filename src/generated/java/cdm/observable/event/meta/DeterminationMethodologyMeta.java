...
public class DeterminationMethodologyMeta implements RosettaMetaData<DeterminationMethodology> {
	...
	@Override
	public List<Validator<? super DeterminationMethodology>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super DeterminationMethodology> validator() {
		return new cdm.observable.event.validation.DeterminationMethodologyValidator();
	}
	
	@Override
	public ValidatorWithArg<? super DeterminationMethodology, Set<String>> onlyExistsValidator() {
		return new cdm.observable.event.validation.exists.DeterminationMethodologyOnlyExistsValidator();
	}
}
