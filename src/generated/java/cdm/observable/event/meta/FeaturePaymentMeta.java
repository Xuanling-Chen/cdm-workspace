...
public class FeaturePaymentMeta implements RosettaMetaData<FeaturePayment> {
	...
	@Override
	public List<Validator<? super FeaturePayment>> choiceRuleValidators() {
		return Arrays.asList(
			new cdm.observable.event.validation.choicerule.FeaturePaymentFeaturePaymentChoice()
		);
	}
	...
	public Validator<? super FeaturePayment> validator() {
		return new cdm.observable.event.validation.FeaturePaymentValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FeaturePayment, Set<String>> onlyExistsValidator() {
		return new cdm.observable.event.validation.exists.FeaturePaymentOnlyExistsValidator();
	}
}
