...
public class ObservationMeta implements RosettaMetaData<Observation> {
	...
	@Override
	public List<Validator<? super Observation>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Observation> validator() {
		return new cdm.observable.event.validation.ObservationValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Observation, Set<String>> onlyExistsValidator() {
		return new cdm.observable.event.validation.exists.ObservationOnlyExistsValidator();
	}
}
