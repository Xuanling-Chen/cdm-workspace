...
public class IndexAdjustmentEventsMeta implements RosettaMetaData<IndexAdjustmentEvents> {
	...
	@Override
	public List<Validator<? super IndexAdjustmentEvents>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super IndexAdjustmentEvents> validator() {
		return new cdm.observable.event.validation.IndexAdjustmentEventsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super IndexAdjustmentEvents, Set<String>> onlyExistsValidator() {
		return new cdm.observable.event.validation.exists.IndexAdjustmentEventsOnlyExistsValidator();
	}
}
