...
public class AcctOwnrValidator implements Validator<AcctOwnr> {
	...
	public ValidationResult<AcctOwnr> validate(RosettaPath path, AcctOwnr o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AcctOwnr", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("AcctOwnr", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
