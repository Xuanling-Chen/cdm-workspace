...
public class FinInstrmValidator implements Validator<FinInstrm> {
	...
	public ValidationResult<FinInstrm> validate(RosettaPath path, FinInstrm o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FinInstrm", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("FinInstrm", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
