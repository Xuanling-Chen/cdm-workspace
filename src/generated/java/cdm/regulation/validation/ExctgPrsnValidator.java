...
public class ExctgPrsnValidator implements Validator<ExctgPrsn> {
	...
	public ValidationResult<ExctgPrsn> validate(RosettaPath path, ExctgPrsn o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("ExctgPrsn", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("ExctgPrsn", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
