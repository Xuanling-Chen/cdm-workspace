...
public class IndxValidator implements Validator<Indx> {
	...
	public ValidationResult<Indx> validate(RosettaPath path, Indx o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("Indx", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("Indx", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
