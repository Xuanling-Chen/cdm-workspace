...
public class QtyValidator implements Validator<Qty> {
	...
	public ValidationResult<Qty> validate(RosettaPath path, Qty o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("Qty", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("Qty", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
