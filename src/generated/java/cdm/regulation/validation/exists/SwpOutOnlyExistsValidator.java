...
public class SwpOutOnlyExistsValidator implements ValidatorWithArg<SwpOut, Set<String>> {
	...
	public <T2 extends SwpOut> ValidationResult<SwpOut> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("sngl", ExistenceChecker.isSet(o.getSngl()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("SwpOut", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("SwpOut", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
