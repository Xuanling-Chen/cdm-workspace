...
public class RefRateOnlyExistsValidator implements ValidatorWithArg<RefRate, Set<String>> {
	...
	public <T2 extends RefRate> ValidationResult<RefRate> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("indx", ExistenceChecker.isSet(o.getIndx()))
				.put("nm", ExistenceChecker.isSet(o.getNm()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("RefRate", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("RefRate", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
