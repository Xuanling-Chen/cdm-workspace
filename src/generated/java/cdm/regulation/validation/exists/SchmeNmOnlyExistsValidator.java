...
public class SchmeNmOnlyExistsValidator implements ValidatorWithArg<SchmeNm, Set<String>> {
	...
	public <T2 extends SchmeNm> ValidationResult<SchmeNm> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("prtry", ExistenceChecker.isSet(o.getPrtry()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("SchmeNm", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("SchmeNm", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
