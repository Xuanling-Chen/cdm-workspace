...
public class OrdrTrnsmssnOnlyExistsValidator implements ValidatorWithArg<OrdrTrnsmssn, Set<String>> {
	...
	public <T2 extends OrdrTrnsmssn> ValidationResult<OrdrTrnsmssn> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("trnsmssnInd", ExistenceChecker.isSet(o.getTrnsmssnInd()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("OrdrTrnsmssn", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("OrdrTrnsmssn", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
