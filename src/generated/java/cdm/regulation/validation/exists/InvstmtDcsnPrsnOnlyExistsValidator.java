...
public class InvstmtDcsnPrsnOnlyExistsValidator implements ValidatorWithArg<InvstmtDcsnPrsn, Set<String>> {
	...
	public <T2 extends InvstmtDcsnPrsn> ValidationResult<InvstmtDcsnPrsn> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("prsn", ExistenceChecker.isSet(o.getPrsn()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("InvstmtDcsnPrsn", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("InvstmtDcsnPrsn", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
