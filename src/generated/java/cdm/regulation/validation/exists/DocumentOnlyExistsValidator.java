...
public class DocumentOnlyExistsValidator implements ValidatorWithArg<Document, Set<String>> {
	...
	public <T2 extends Document> ValidationResult<Document> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("finInstrmRptgTxRpt", ExistenceChecker.isSet(o.getFinInstrmRptgTxRpt()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Document", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("Document", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
