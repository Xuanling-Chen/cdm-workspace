...
public class UndrlygInstrmOnlyExistsValidator implements ValidatorWithArg<UndrlygInstrm, Set<String>> {
	...
	public <T2 extends UndrlygInstrm> ValidationResult<UndrlygInstrm> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("swp", ExistenceChecker.isSet(o.getSwp()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("UndrlygInstrm", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("UndrlygInstrm", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
