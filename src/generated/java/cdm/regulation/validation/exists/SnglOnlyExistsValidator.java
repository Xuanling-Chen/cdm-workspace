...
public class SnglOnlyExistsValidator implements ValidatorWithArg<Sngl, Set<String>> {
	...
	public <T2 extends Sngl> ValidationResult<Sngl> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("isin", ExistenceChecker.isSet(o.getIsin()))
		...
		if (setFields.equals(fields)) {
			return success("Sngl", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("Sngl", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
