...
public class IndxMeta implements RosettaMetaData<Indx> {
	...
	@Override
	public List<Validator<? super Indx>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Indx> validator() {
		return new cdm.regulation.validation.IndxValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Indx, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.IndxOnlyExistsValidator();
	}
}
