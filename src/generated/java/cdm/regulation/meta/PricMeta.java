...
public class PricMeta implements RosettaMetaData<Pric> {
	...
	@Override
	public List<Validator<? super Pric>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Pric> validator() {
		return new cdm.regulation.validation.PricValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Pric, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.PricOnlyExistsValidator();
	}
}
