...
public class AcctOwnrMeta implements RosettaMetaData<AcctOwnr> {
	...
	@Override
	public List<Validator<? super AcctOwnr>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AcctOwnr> validator() {
		return new cdm.regulation.validation.AcctOwnrValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AcctOwnr, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.AcctOwnrOnlyExistsValidator();
	}
}
