...
public class TxMeta implements RosettaMetaData<Tx> {
	...
	@Override
	public List<Validator<? super Tx>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Tx> validator() {
		return new cdm.regulation.validation.TxValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Tx, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.TxOnlyExistsValidator();
	}
}
