...
public class SwpInMeta implements RosettaMetaData<SwpIn> {
	...
	@Override
	public List<Validator<? super SwpIn>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super SwpIn> validator() {
		return new cdm.regulation.validation.SwpInValidator();
	}
	
	@Override
	public ValidatorWithArg<? super SwpIn, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.SwpInOnlyExistsValidator();
	}
}
