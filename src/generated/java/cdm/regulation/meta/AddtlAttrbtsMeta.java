...
public class AddtlAttrbtsMeta implements RosettaMetaData<AddtlAttrbts> {
	...
	@Override
	public List<Validator<? super AddtlAttrbts>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AddtlAttrbts> validator() {
		return new cdm.regulation.validation.AddtlAttrbtsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AddtlAttrbts, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.AddtlAttrbtsOnlyExistsValidator();
	}
}
