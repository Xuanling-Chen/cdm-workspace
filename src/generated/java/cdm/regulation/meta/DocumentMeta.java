...
public class DocumentMeta implements RosettaMetaData<Document> {
	...
	@Override
	public List<Validator<? super Document>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Document> validator() {
		return new cdm.regulation.validation.DocumentValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Document, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.DocumentOnlyExistsValidator();
	}
}
