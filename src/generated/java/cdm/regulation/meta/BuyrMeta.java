...
public class BuyrMeta implements RosettaMetaData<Buyr> {
	...
	@Override
	public List<Validator<? super Buyr>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Buyr> validator() {
		return new cdm.regulation.validation.BuyrValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Buyr, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.BuyrOnlyExistsValidator();
	}
}
