...
public class OthrMeta implements RosettaMetaData<Othr> {
	...
	@Override
	public List<Validator<? super Othr>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Othr> validator() {
		return new cdm.regulation.validation.OthrValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Othr, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.OthrOnlyExistsValidator();
	}
}
