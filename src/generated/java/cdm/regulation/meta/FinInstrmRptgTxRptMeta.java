...
public class FinInstrmRptgTxRptMeta implements RosettaMetaData<FinInstrmRptgTxRpt> {
	...
	@Override
	public List<Validator<? super FinInstrmRptgTxRpt>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super FinInstrmRptgTxRpt> validator() {
		return new cdm.regulation.validation.FinInstrmRptgTxRptValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FinInstrmRptgTxRpt, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.FinInstrmRptgTxRptOnlyExistsValidator();
	}
}
