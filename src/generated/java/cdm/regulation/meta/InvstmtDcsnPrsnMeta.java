...
public class InvstmtDcsnPrsnMeta implements RosettaMetaData<InvstmtDcsnPrsn> {
	...
	@Override
	public List<Validator<? super InvstmtDcsnPrsn>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super InvstmtDcsnPrsn> validator() {
		return new cdm.regulation.validation.InvstmtDcsnPrsnValidator();
	}
	
	@Override
	public ValidatorWithArg<? super InvstmtDcsnPrsn, Set<String>> onlyExistsValidator() {
		return new cdm.regulation.validation.exists.InvstmtDcsnPrsnOnlyExistsValidator();
	}
}
