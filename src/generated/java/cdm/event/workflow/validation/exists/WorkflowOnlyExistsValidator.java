...
public class WorkflowOnlyExistsValidator implements ValidatorWithArg<Workflow, Set<String>> {
	...
	public <T2 extends Workflow> ValidationResult<Workflow> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("steps", ExistenceChecker.isSet(o.getSteps()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Workflow", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("Workflow", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
