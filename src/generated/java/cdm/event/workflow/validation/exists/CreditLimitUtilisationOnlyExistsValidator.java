...
public class CreditLimitUtilisationOnlyExistsValidator implements ValidatorWithArg<CreditLimitUtilisation, Set<String>> {
	...
	public <T2 extends CreditLimitUtilisation> ValidationResult<CreditLimitUtilisation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("executed", ExistenceChecker.isSet(o.getExecuted()))
				.put("pending", ExistenceChecker.isSet(o.getPending()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CreditLimitUtilisation", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("CreditLimitUtilisation", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
