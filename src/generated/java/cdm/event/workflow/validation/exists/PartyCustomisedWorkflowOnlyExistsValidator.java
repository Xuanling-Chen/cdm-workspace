...
public class PartyCustomisedWorkflowOnlyExistsValidator implements ValidatorWithArg<PartyCustomisedWorkflow, Set<String>> {
	...
	public <T2 extends PartyCustomisedWorkflow> ValidationResult<PartyCustomisedWorkflow> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("partyName", ExistenceChecker.isSet(o.getPartyName()))
				.put("customisedWorkflow", ExistenceChecker.isSet(o.getCustomisedWorkflow()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("PartyCustomisedWorkflow", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("PartyCustomisedWorkflow", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
