...
public class WorkflowMeta implements RosettaMetaData<Workflow> {
	...
	@Override
	public List<Validator<? super Workflow>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Workflow> validator() {
		return new cdm.event.workflow.validation.WorkflowValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Workflow, Set<String>> onlyExistsValidator() {
		return new cdm.event.workflow.validation.exists.WorkflowOnlyExistsValidator();
	}
}
