...
public class EventTimestampMeta implements RosettaMetaData<EventTimestamp> {
	...
	@Override
	public List<Validator<? super EventTimestamp>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super EventTimestamp> validator() {
		return new cdm.event.workflow.validation.EventTimestampValidator();
	}
	
	@Override
	public ValidatorWithArg<? super EventTimestamp, Set<String>> onlyExistsValidator() {
		return new cdm.event.workflow.validation.exists.EventTimestampOnlyExistsValidator();
	}
}
