...
public class LimitApplicableExtendedMeta implements RosettaMetaData<LimitApplicableExtended> {
	...
	@Override
	public List<Validator<? super LimitApplicableExtended>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super LimitApplicableExtended> validator() {
		return new cdm.event.workflow.validation.LimitApplicableExtendedValidator();
	}
	
	@Override
	public ValidatorWithArg<? super LimitApplicableExtended, Set<String>> onlyExistsValidator() {
		return new cdm.event.workflow.validation.exists.LimitApplicableExtendedOnlyExistsValidator();
	}
}
