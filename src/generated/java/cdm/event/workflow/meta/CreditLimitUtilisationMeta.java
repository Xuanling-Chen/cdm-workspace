...
public class CreditLimitUtilisationMeta implements RosettaMetaData<CreditLimitUtilisation> {
	...
	@Override
	public List<Validator<? super CreditLimitUtilisation>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CreditLimitUtilisation> validator() {
		return new cdm.event.workflow.validation.CreditLimitUtilisationValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CreditLimitUtilisation, Set<String>> onlyExistsValidator() {
		return new cdm.event.workflow.validation.exists.CreditLimitUtilisationOnlyExistsValidator();
	}
}
