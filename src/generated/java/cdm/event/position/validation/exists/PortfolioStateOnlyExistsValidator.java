...
public class PortfolioStateOnlyExistsValidator implements ValidatorWithArg<PortfolioState, Set<String>> {
	...
	public <T2 extends PortfolioState> ValidationResult<PortfolioState> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("positions", ExistenceChecker.isSet(o.getPositions()))
		...
		if (setFields.equals(fields)) {
			return success("PortfolioState", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("PortfolioState", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
