...
public class AggregationParametersMeta implements RosettaMetaData<AggregationParameters> {
	...
	@Override
	public List<Validator<? super AggregationParameters>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AggregationParameters> validator() {
		return new cdm.event.position.validation.AggregationParametersValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AggregationParameters, Set<String>> onlyExistsValidator() {
		return new cdm.event.position.validation.exists.AggregationParametersOnlyExistsValidator();
	}
}
