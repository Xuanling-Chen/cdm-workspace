...
public class PortfolioMeta implements RosettaMetaData<Portfolio> {
	...
	@Override
	public List<Validator<? super Portfolio>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Portfolio> validator() {
		return new cdm.event.position.validation.PortfolioValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Portfolio, Set<String>> onlyExistsValidator() {
		return new cdm.event.position.validation.exists.PortfolioOnlyExistsValidator();
	}
}
