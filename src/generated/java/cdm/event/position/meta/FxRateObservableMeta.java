...
public class FxRateObservableMeta implements RosettaMetaData<FxRateObservable> {
	...
	@Override
	public List<Validator<? super FxRateObservable>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super FxRateObservable> validator() {
		return new cdm.event.position.validation.FxRateObservableValidator();
	}
	
	@Override
	public ValidatorWithArg<? super FxRateObservable, Set<String>> onlyExistsValidator() {
		return new cdm.event.position.validation.exists.FxRateObservableOnlyExistsValidator();
	}
}
