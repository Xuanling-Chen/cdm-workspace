...
public class PositionMeta implements RosettaMetaData<Position> {
	...
	@Override
	public List<Validator<? super Position>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Position> validator() {
		return new cdm.event.position.validation.PositionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Position, Set<String>> onlyExistsValidator() {
		return new cdm.event.position.validation.exists.PositionOnlyExistsValidator();
	}
}
