...
public abstract class Qualify_Increase implements RosettaFunction, IQualifyFunctionExtension<BusinessEvent> {
	...
	*/
	...
	public static final class Qualify_IncreaseDefault extends Qualify_Increase {
		@Override
