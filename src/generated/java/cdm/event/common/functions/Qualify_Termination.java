...
public abstract class Qualify_Termination implements RosettaFunction, IQualifyFunctionExtension<BusinessEvent> {
	...
	*/
	...
	public static final class Qualify_TerminationDefault extends Qualify_Termination {
		@Override
