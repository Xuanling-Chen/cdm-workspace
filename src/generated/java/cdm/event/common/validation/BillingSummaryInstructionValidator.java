...
public class BillingSummaryInstructionValidator implements Validator<BillingSummaryInstruction> {
	...
	public ValidationResult<BillingSummaryInstruction> validate(RosettaPath path, BillingSummaryInstruction o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("BillingSummaryInstruction", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("BillingSummaryInstruction", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
