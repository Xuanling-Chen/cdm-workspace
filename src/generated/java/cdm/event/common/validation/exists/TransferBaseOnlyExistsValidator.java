...
public class TransferBaseOnlyExistsValidator implements ValidatorWithArg<TransferBase, Set<String>> {
	...
	public <T2 extends TransferBase> ValidationResult<TransferBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("transferCalculation", ExistenceChecker.isSet(o.getTransferCalculation()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("TransferBase", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("TransferBase", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
