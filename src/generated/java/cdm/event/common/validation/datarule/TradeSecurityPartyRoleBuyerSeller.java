...
public class TradeSecurityPartyRoleBuyerSeller implements Validator<Trade> {
	
	private static final String NAME = "TradeSecurityPartyRoleBuyerSeller";
	private static final String DEFINITION = "if tradableProduct -> product -> security exists then partyRole -> role contains PartyRoleEnum -> Buyer and partyRole -> role contains PartyRoleEnum -> Seller";
