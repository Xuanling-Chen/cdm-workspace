...
public class AffirmationMeta implements RosettaMetaData<Affirmation> {
	...
	@Override
	public List<Validator<? super Affirmation>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Affirmation> validator() {
		return new cdm.event.common.validation.AffirmationValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Affirmation, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.AffirmationOnlyExistsValidator();
	}
}
