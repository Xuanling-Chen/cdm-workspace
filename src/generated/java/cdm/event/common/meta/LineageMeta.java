...
public class LineageMeta implements RosettaMetaData<Lineage> {
	...
	@Override
	public List<Validator<? super Lineage>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Lineage> validator() {
		return new cdm.event.common.validation.LineageValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Lineage, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.LineageOnlyExistsValidator();
	}
}
