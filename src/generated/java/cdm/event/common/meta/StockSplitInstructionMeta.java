...
public class StockSplitInstructionMeta implements RosettaMetaData<StockSplitInstruction> {
	...
	@Override
	public List<Validator<? super StockSplitInstruction>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super StockSplitInstruction> validator() {
		return new cdm.event.common.validation.StockSplitInstructionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super StockSplitInstruction, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.StockSplitInstructionOnlyExistsValidator();
	}
}
