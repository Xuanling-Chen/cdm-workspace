...
public class TradeMeta implements RosettaMetaData<Trade> {
	...
	public List<Validator<? super Trade>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.create(cdm.event.common.validation.datarule.TradeSecurityPartyRole.class),
			...
			factory.create(cdm.event.common.validation.datarule.TradeContractualProductExists.class),
	...
	@Override
	public List<Validator<? super Trade>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Trade> validator() {
		return new cdm.event.common.validation.TradeValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Trade, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.TradeOnlyExistsValidator();
	}
}
