...
public class TransferInstructionMeta implements RosettaMetaData<TransferInstruction> {
	...
	@Override
	public List<Validator<? super TransferInstruction>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super TransferInstruction> validator() {
		return new cdm.event.common.validation.TransferInstructionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super TransferInstruction, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.TransferInstructionOnlyExistsValidator();
	}
}
