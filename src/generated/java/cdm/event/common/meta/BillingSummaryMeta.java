...
public class BillingSummaryMeta implements RosettaMetaData<BillingSummary> {
	...
	@Override
	public List<Validator<? super BillingSummary>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super BillingSummary> validator() {
		return new cdm.event.common.validation.BillingSummaryValidator();
	}
	
	@Override
	public ValidatorWithArg<? super BillingSummary, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.BillingSummaryOnlyExistsValidator();
	}
}
