...
public class ContractFormationInstructionMeta implements RosettaMetaData<ContractFormationInstruction> {
	...
	@Override
	public List<Validator<? super ContractFormationInstruction>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ContractFormationInstruction> validator() {
		return new cdm.event.common.validation.ContractFormationInstructionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ContractFormationInstruction, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.ContractFormationInstructionOnlyExistsValidator();
	}
}
