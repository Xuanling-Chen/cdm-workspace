...
public class TradeStateMeta implements RosettaMetaData<TradeState> {
	...
	@Override
	public List<Validator<? super TradeState>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super TradeState> validator() {
		return new cdm.event.common.validation.TradeStateValidator();
	}
	
	@Override
	public ValidatorWithArg<? super TradeState, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.TradeStateOnlyExistsValidator();
	}
}
