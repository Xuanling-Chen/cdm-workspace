...
public class BillingRecordMeta implements RosettaMetaData<BillingRecord> {
	...
	@Override
	public List<Validator<? super BillingRecord>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super BillingRecord> validator() {
		return new cdm.event.common.validation.BillingRecordValidator();
	}
	
	@Override
	public ValidatorWithArg<? super BillingRecord, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.BillingRecordOnlyExistsValidator();
	}
}
