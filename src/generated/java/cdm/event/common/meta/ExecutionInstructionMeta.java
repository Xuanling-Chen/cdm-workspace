...
public class ExecutionInstructionMeta implements RosettaMetaData<ExecutionInstruction> {
	...
	@Override
	public List<Validator<? super ExecutionInstruction>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ExecutionInstruction> validator() {
		return new cdm.event.common.validation.ExecutionInstructionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ExecutionInstruction, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.ExecutionInstructionOnlyExistsValidator();
	}
}
