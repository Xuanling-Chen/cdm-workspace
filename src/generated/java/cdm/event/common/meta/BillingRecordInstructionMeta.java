...
public class BillingRecordInstructionMeta implements RosettaMetaData<BillingRecordInstruction> {
	...
	@Override
	public List<Validator<? super BillingRecordInstruction>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super BillingRecordInstruction> validator() {
		return new cdm.event.common.validation.BillingRecordInstructionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super BillingRecordInstruction, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.BillingRecordInstructionOnlyExistsValidator();
	}
}
