...
public class BillingInstructionMeta implements RosettaMetaData<BillingInstruction> {
	...
	@Override
	public List<Validator<? super BillingInstruction>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super BillingInstruction> validator() {
		return new cdm.event.common.validation.BillingInstructionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super BillingInstruction, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.BillingInstructionOnlyExistsValidator();
	}
}
