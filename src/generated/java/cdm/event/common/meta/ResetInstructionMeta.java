...
public class ResetInstructionMeta implements RosettaMetaData<ResetInstruction> {
	...
	@Override
	public List<Validator<? super ResetInstruction>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ResetInstruction> validator() {
		return new cdm.event.common.validation.ResetInstructionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ResetInstruction, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.ResetInstructionOnlyExistsValidator();
	}
}
