...
public class SecurityLendingInvoiceMeta implements RosettaMetaData<SecurityLendingInvoice> {
	...
	@Override
	public List<Validator<? super SecurityLendingInvoice>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super SecurityLendingInvoice> validator() {
		return new cdm.event.common.validation.SecurityLendingInvoiceValidator();
	}
	
	@Override
	public ValidatorWithArg<? super SecurityLendingInvoice, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.SecurityLendingInvoiceOnlyExistsValidator();
	}
}
