...
public class TransferMeta implements RosettaMetaData<Transfer> {
	...
	public List<Validator<? super Transfer>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.create(cdm.event.common.validation.datarule.TransferDataRule0.class)
		);
	}

	@Override
	public List<Validator<? super Transfer>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Transfer> validator() {
		return new cdm.event.common.validation.TransferValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Transfer, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.TransferOnlyExistsValidator();
	}
}
