...
public class InstructionMeta implements RosettaMetaData<Instruction> {
	...
	@Override
	public List<Validator<? super Instruction>> choiceRuleValidators() {
		return Arrays.asList(
			new cdm.event.common.validation.choicerule.InstructionOneOfInstruction()
		);
	}
	...
	public Validator<? super Instruction> validator() {
		return new cdm.event.common.validation.InstructionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Instruction, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.InstructionOnlyExistsValidator();
	}
}
