...
public class ExecutionDetailsMeta implements RosettaMetaData<ExecutionDetails> {
	...
	@Override
	public List<Validator<? super ExecutionDetails>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ExecutionDetails> validator() {
		return new cdm.event.common.validation.ExecutionDetailsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ExecutionDetails, Set<String>> onlyExistsValidator() {
		return new cdm.event.common.validation.exists.ExecutionDetailsOnlyExistsValidator();
	}
}
