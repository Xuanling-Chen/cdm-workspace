...
public class EquityMasterConfirmationMeta implements RosettaMetaData<EquityMasterConfirmation> {
	...
	@Override
	public List<Validator<? super EquityMasterConfirmation>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super EquityMasterConfirmation> validator() {
		return new cdm.legalagreement.master.validation.EquityMasterConfirmationValidator();
	}
	
	@Override
	public ValidatorWithArg<? super EquityMasterConfirmation, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.master.validation.exists.EquityMasterConfirmationOnlyExistsValidator();
	}
}
