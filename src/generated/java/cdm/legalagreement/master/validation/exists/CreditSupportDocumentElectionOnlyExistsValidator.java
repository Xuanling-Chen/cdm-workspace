...
public class CreditSupportDocumentElectionOnlyExistsValidator implements ValidatorWithArg<CreditSupportDocumentElection, Set<String>> {
	...
	public <T2 extends CreditSupportDocumentElection> ValidationResult<CreditSupportDocumentElection> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("creditSupportDocumentTerms", ExistenceChecker.isSet(o.getCreditSupportDocumentTerms()))
				.put("creditSupportDocument", ExistenceChecker.isSet(o.getCreditSupportDocument()))
				.put("bespokeCreditSuppportDocument", ExistenceChecker.isSet(o.getBespokeCreditSuppportDocument()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CreditSupportDocumentElection", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("CreditSupportDocumentElection", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
