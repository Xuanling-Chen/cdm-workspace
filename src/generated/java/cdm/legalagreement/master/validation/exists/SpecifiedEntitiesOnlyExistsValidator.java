...
public class SpecifiedEntitiesOnlyExistsValidator implements ValidatorWithArg<SpecifiedEntities, Set<String>> {
	...
	public <T2 extends SpecifiedEntities> ValidationResult<SpecifiedEntities> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("specifiedEntityClause", ExistenceChecker.isSet(o.getSpecifiedEntityClause()))
		...
		if (setFields.equals(fields)) {
			return success("SpecifiedEntities", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("SpecifiedEntities", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
