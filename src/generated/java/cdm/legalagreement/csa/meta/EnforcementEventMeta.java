...
public class EnforcementEventMeta implements RosettaMetaData<EnforcementEvent> {
	...
	@Override
	public List<Validator<? super EnforcementEvent>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super EnforcementEvent> validator() {
		return new cdm.legalagreement.csa.validation.EnforcementEventValidator();
	}
	
	@Override
	public ValidatorWithArg<? super EnforcementEvent, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.EnforcementEventOnlyExistsValidator();
	}
}
