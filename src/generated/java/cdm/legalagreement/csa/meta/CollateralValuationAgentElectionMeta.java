...
public class CollateralValuationAgentElectionMeta implements RosettaMetaData<CollateralValuationAgentElection> {
	...
	@Override
	public List<Validator<? super CollateralValuationAgentElection>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CollateralValuationAgentElection> validator() {
		return new cdm.legalagreement.csa.validation.CollateralValuationAgentElectionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CollateralValuationAgentElection, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.CollateralValuationAgentElectionOnlyExistsValidator();
	}
}
