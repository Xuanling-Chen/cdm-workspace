...
public class AdditionalObligationsMeta implements RosettaMetaData<AdditionalObligations> {
	...
	@Override
	public List<Validator<? super AdditionalObligations>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AdditionalObligations> validator() {
		return new cdm.legalagreement.csa.validation.AdditionalObligationsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AdditionalObligations, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.AdditionalObligationsOnlyExistsValidator();
	}
}
