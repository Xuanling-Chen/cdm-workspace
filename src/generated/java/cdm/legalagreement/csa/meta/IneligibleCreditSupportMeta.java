...
public class IneligibleCreditSupportMeta implements RosettaMetaData<IneligibleCreditSupport> {
	...
	@Override
	public List<Validator<? super IneligibleCreditSupport>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super IneligibleCreditSupport> validator() {
		return new cdm.legalagreement.csa.validation.IneligibleCreditSupportValidator();
	}
	
	@Override
	public ValidatorWithArg<? super IneligibleCreditSupport, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.IneligibleCreditSupportOnlyExistsValidator();
	}
}
