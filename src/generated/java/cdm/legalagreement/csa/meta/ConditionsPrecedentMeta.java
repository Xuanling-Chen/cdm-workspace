...
public class ConditionsPrecedentMeta implements RosettaMetaData<ConditionsPrecedent> {
	...
	public List<Validator<? super ConditionsPrecedent>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.create(cdm.legalagreement.csa.validation.datarule.ConditionsPrecedentCustomProvision.class)
		);
	}

	@Override
	public List<Validator<? super ConditionsPrecedent>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ConditionsPrecedent> validator() {
		return new cdm.legalagreement.csa.validation.ConditionsPrecedentValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ConditionsPrecedent, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.ConditionsPrecedentOnlyExistsValidator();
	}
}
