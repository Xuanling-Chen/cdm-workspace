...
public class NotificationTimeElectionMeta implements RosettaMetaData<NotificationTimeElection> {
	...
	@Override
	public List<Validator<? super NotificationTimeElection>> choiceRuleValidators() {
		return Arrays.asList(
			new cdm.legalagreement.csa.validation.choicerule.NotificationTimeElectionNotificationTimeElectionChoice()
		);
	}
	...
	public Validator<? super NotificationTimeElection> validator() {
		return new cdm.legalagreement.csa.validation.NotificationTimeElectionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super NotificationTimeElection, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.NotificationTimeElectionOnlyExistsValidator();
	}
}
