...
public class CreditSupportObligationsVariationMarginMeta implements RosettaMetaData<CreditSupportObligationsVariationMargin> {
	...
	@Override
	public List<Validator<? super CreditSupportObligationsVariationMargin>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CreditSupportObligationsVariationMargin> validator() {
		return new cdm.legalagreement.csa.validation.CreditSupportObligationsVariationMarginValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CreditSupportObligationsVariationMargin, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.CreditSupportObligationsVariationMarginOnlyExistsValidator();
	}
}
