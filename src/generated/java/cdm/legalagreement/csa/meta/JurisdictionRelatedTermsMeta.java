...
public class JurisdictionRelatedTermsMeta implements RosettaMetaData<JurisdictionRelatedTerms> {
	...
	@Override
	public List<Validator<? super JurisdictionRelatedTerms>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super JurisdictionRelatedTerms> validator() {
		return new cdm.legalagreement.csa.validation.JurisdictionRelatedTermsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super JurisdictionRelatedTerms, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.JurisdictionRelatedTermsOnlyExistsValidator();
	}
}
