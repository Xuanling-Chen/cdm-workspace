...
public class MinimumTransferAmountAmendmentMeta implements RosettaMetaData<MinimumTransferAmountAmendment> {
	...
	public List<Validator<? super MinimumTransferAmountAmendment>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.create(cdm.legalagreement.csa.validation.datarule.MinimumTransferAmountAmendmentAmendmentNotApplicable.class)
		);
	}

	@Override
	public List<Validator<? super MinimumTransferAmountAmendment>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super MinimumTransferAmountAmendment> validator() {
		return new cdm.legalagreement.csa.validation.MinimumTransferAmountAmendmentValidator();
	}
	
	@Override
	public ValidatorWithArg<? super MinimumTransferAmountAmendment, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.MinimumTransferAmountAmendmentOnlyExistsValidator();
	}
}
