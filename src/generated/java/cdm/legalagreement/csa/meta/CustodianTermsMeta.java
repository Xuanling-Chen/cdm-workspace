...
public class CustodianTermsMeta implements RosettaMetaData<CustodianTerms> {
	...
	@Override
	public List<Validator<? super CustodianTerms>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CustodianTerms> validator() {
		return new cdm.legalagreement.csa.validation.CustodianTermsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CustodianTerms, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.CustodianTermsOnlyExistsValidator();
	}
}
