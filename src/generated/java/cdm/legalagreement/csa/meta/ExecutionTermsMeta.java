...
public class ExecutionTermsMeta implements RosettaMetaData<ExecutionTerms> {
	...
	@Override
	public List<Validator<? super ExecutionTerms>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ExecutionTerms> validator() {
		return new cdm.legalagreement.csa.validation.ExecutionTermsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ExecutionTerms, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.ExecutionTermsOnlyExistsValidator();
	}
}
