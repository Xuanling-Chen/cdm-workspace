...
public class ProcessAgentMeta implements RosettaMetaData<ProcessAgent> {
	...
	@Override
	public List<Validator<? super ProcessAgent>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ProcessAgent> validator() {
		return new cdm.legalagreement.csa.validation.ProcessAgentValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ProcessAgent, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.ProcessAgentOnlyExistsValidator();
	}
}
