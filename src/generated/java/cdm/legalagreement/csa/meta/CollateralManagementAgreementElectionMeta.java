...
public class CollateralManagementAgreementElectionMeta implements RosettaMetaData<CollateralManagementAgreementElection> {
	...
	@Override
	public List<Validator<? super CollateralManagementAgreementElection>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CollateralManagementAgreementElection> validator() {
		return new cdm.legalagreement.csa.validation.CollateralManagementAgreementElectionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CollateralManagementAgreementElection, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.CollateralManagementAgreementElectionOnlyExistsValidator();
	}
}
