...
public class ControlAgreementNecEventElectionMeta implements RosettaMetaData<ControlAgreementNecEventElection> {
	...
	@Override
	public List<Validator<? super ControlAgreementNecEventElection>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ControlAgreementNecEventElection> validator() {
		return new cdm.legalagreement.csa.validation.ControlAgreementNecEventElectionValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ControlAgreementNecEventElection, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.ControlAgreementNecEventElectionOnlyExistsValidator();
	}
}
