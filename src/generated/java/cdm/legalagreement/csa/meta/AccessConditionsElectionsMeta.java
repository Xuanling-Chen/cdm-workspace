...
public class AccessConditionsElectionsMeta implements RosettaMetaData<AccessConditionsElections> {
	...
	@Override
	public List<Validator<? super AccessConditionsElections>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AccessConditionsElections> validator() {
		return new cdm.legalagreement.csa.validation.AccessConditionsElectionsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AccessConditionsElections, Set<String>> onlyExistsValidator() {
		return new cdm.legalagreement.csa.validation.exists.AccessConditionsElectionsOnlyExistsValidator();
	}
}
