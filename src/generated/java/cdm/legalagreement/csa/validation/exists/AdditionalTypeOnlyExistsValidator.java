...
public class AdditionalTypeOnlyExistsValidator implements ValidatorWithArg<AdditionalType, Set<String>> {
	...
	public <T2 extends AdditionalType> ValidationResult<AdditionalType> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("standardValue", ExistenceChecker.isSet(o.getStandardValue()))
				.put("customValue", ExistenceChecker.isSet(o.getCustomValue()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AdditionalType", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("AdditionalType", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
