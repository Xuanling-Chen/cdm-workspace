...
public class GeneralSimmElectionsOnlyExistsValidator implements ValidatorWithArg<GeneralSimmElections, Set<String>> {
	...
	public <T2 extends GeneralSimmElections> ValidationResult<GeneralSimmElections> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("simmVersion", ExistenceChecker.isSet(o.getSimmVersion()))
				.put("simmCalculationCurrency", ExistenceChecker.isSet(o.getSimmCalculationCurrency()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("GeneralSimmElections", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("GeneralSimmElections", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
