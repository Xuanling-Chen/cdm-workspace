...
public class IndependentAmountOnlyExistsValidator implements ValidatorWithArg<IndependentAmount, Set<String>> {
	...
	public <T2 extends IndependentAmount> ValidationResult<IndependentAmount> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("paymentDetail", ExistenceChecker.isSet(o.getPaymentDetail()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("IndependentAmount", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("IndependentAmount", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
