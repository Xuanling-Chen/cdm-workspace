...
public class NotificationTimeElectionOnlyExistsValidator implements ValidatorWithArg<NotificationTimeElection, Set<String>> {
	...
	public <T2 extends NotificationTimeElection> ValidationResult<NotificationTimeElection> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("customNotification", ExistenceChecker.isSet(o.getCustomNotification()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("NotificationTimeElection", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("NotificationTimeElection", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
