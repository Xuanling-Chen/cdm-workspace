...
public class RecalculationOfValueElectionOnlyExistsValidator implements ValidatorWithArg<RecalculationOfValueElection, Set<String>> {
	...
	public <T2 extends RecalculationOfValueElection> ValidationResult<RecalculationOfValueElection> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("recalculationOfValueElection", ExistenceChecker.isSet(o.getRecalculationOfValueElection()))
				.put("recalculationOfValueTerms", ExistenceChecker.isSet(o.getRecalculationOfValueTerms()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("RecalculationOfValueElection", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("RecalculationOfValueElection", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
