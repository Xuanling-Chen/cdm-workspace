...
public class SensitivityMethodologyOnlyExistsValidator implements ValidatorWithArg<SensitivityMethodology, Set<String>> {
	...
	public <T2 extends SensitivityMethodology> ValidationResult<SensitivityMethodology> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("specifiedMethodology", ExistenceChecker.isSet(o.getSpecifiedMethodology()))
				.put("customMethodology", ExistenceChecker.isSet(o.getCustomMethodology()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("SensitivityMethodology", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("SensitivityMethodology", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
