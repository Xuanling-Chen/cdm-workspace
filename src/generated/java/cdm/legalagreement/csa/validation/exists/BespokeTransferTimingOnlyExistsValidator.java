...
public class BespokeTransferTimingOnlyExistsValidator implements ValidatorWithArg<BespokeTransferTiming, Set<String>> {
	...
	public <T2 extends BespokeTransferTiming> ValidationResult<BespokeTransferTiming> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("bespokeTransferTimingTerms", ExistenceChecker.isSet(o.getBespokeTransferTimingTerms()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("BespokeTransferTiming", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("BespokeTransferTiming", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
