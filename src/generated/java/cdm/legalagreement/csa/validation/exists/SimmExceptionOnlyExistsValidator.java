...
public class SimmExceptionOnlyExistsValidator implements ValidatorWithArg<SimmException, Set<String>> {
	...
	public <T2 extends SimmException> ValidationResult<SimmException> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("standardisedException", ExistenceChecker.isSet(o.getStandardisedException()))
				.put("simmExceptionApplicable", ExistenceChecker.isSet(o.getSimmExceptionApplicable()))
		...
		if (setFields.equals(fields)) {
			return success("SimmException", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("SimmException", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
