...
public class CreditSupportObligationsVariationMarginOnlyExistsValidator implements ValidatorWithArg<CreditSupportObligationsVariationMargin, Set<String>> {
	...
	public <T2 extends CreditSupportObligationsVariationMargin> ValidationResult<CreditSupportObligationsVariationMargin> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("ineligibleCreditSupport", ExistenceChecker.isSet(o.getIneligibleCreditSupport()))
				.put("majorCurrency", ExistenceChecker.isSet(o.getMajorCurrency()))
				.put("fxHaircut", ExistenceChecker.isSet(o.getFxHaircut()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("CreditSupportObligationsVariationMargin", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("CreditSupportObligationsVariationMargin", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
