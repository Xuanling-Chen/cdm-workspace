...
public class ExecutionTermsOnlyExistsValidator implements ValidatorWithArg<ExecutionTerms, Set<String>> {
	...
	public <T2 extends ExecutionTerms> ValidationResult<ExecutionTerms> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("executionLanguage", ExistenceChecker.isSet(o.getExecutionLanguage()))
		...
		if (setFields.equals(fields)) {
			return success("ExecutionTerms", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ExecutionTerms", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
