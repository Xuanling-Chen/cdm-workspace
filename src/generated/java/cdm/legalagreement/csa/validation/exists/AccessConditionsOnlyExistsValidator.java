...
public class AccessConditionsOnlyExistsValidator implements ValidatorWithArg<AccessConditions, Set<String>> {
	...
	public <T2 extends AccessConditions> ValidationResult<AccessConditions> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("additionalTerminationEvent", ExistenceChecker.isSet(o.getAdditionalTerminationEvent()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AccessConditions", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("AccessConditions", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
