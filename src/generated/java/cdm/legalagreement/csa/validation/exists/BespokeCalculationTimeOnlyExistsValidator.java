...
public class BespokeCalculationTimeOnlyExistsValidator implements ValidatorWithArg<BespokeCalculationTime, Set<String>> {
	...
	public <T2 extends BespokeCalculationTime> ValidationResult<BespokeCalculationTime> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("asCalculationAgent", ExistenceChecker.isSet(o.getAsCalculationAgent()))
				.put("bespokeCalculationTimeTerms", ExistenceChecker.isSet(o.getBespokeCalculationTimeTerms()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("BespokeCalculationTime", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("BespokeCalculationTime", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
