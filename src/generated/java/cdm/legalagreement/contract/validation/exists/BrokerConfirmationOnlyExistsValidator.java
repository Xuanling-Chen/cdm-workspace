...
public class BrokerConfirmationOnlyExistsValidator implements ValidatorWithArg<BrokerConfirmation, Set<String>> {
	...
	public <T2 extends BrokerConfirmation> ValidationResult<BrokerConfirmation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("brokerConfirmationType", ExistenceChecker.isSet(o.getBrokerConfirmationType()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("BrokerConfirmation", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("BrokerConfirmation", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
