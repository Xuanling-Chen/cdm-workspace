...
public class ContractualMatrixOnlyExistsValidator implements ValidatorWithArg<ContractualMatrix, Set<String>> {
	...
	public <T2 extends ContractualMatrix> ValidationResult<ContractualMatrix> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("matrixType", ExistenceChecker.isSet(o.getMatrixType()))
				.put("publicationDate", ExistenceChecker.isSet(o.getPublicationDate()))
				.put("matrixTerm", ExistenceChecker.isSet(o.getMatrixTerm()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ContractualMatrix", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ContractualMatrix", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
