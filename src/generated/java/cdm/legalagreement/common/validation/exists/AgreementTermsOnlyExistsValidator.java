...
public class AgreementTermsOnlyExistsValidator implements ValidatorWithArg<AgreementTerms, Set<String>> {
	...
	public <T2 extends AgreementTerms> ValidationResult<AgreementTerms> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("agreement", ExistenceChecker.isSet(o.getAgreement()))
		...
		if (setFields.equals(fields)) {
			return success("AgreementTerms", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("AgreementTerms", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
