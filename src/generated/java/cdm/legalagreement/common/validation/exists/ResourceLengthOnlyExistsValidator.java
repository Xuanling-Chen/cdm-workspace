...
public class ResourceLengthOnlyExistsValidator implements ValidatorWithArg<ResourceLength, Set<String>> {
	...
	public <T2 extends ResourceLength> ValidationResult<ResourceLength> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("lengthUnit", ExistenceChecker.isSet(o.getLengthUnit()))
				.put("lengthValue", ExistenceChecker.isSet(o.getLengthValue()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ResourceLength", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ResourceLength", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
