...
public class OtherAgreementOnlyExistsValidator implements ValidatorWithArg<OtherAgreement, Set<String>> {
	...
	public <T2 extends OtherAgreement> ValidationResult<OtherAgreement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("otherAgreementType", ExistenceChecker.isSet(o.getOtherAgreementType()))
		...
		if (setFields.equals(fields)) {
			return success("OtherAgreement", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("OtherAgreement", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
