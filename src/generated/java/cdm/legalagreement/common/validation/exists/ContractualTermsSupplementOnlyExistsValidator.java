...
public class ContractualTermsSupplementOnlyExistsValidator implements ValidatorWithArg<ContractualTermsSupplement, Set<String>> {
	...
	public <T2 extends ContractualTermsSupplement> ValidationResult<ContractualTermsSupplement> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("contractualTermsSupplementType", ExistenceChecker.isSet(o.getContractualTermsSupplementType()))
		...
		if (setFields.equals(fields)) {
			return success("ContractualTermsSupplement", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ContractualTermsSupplement", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
