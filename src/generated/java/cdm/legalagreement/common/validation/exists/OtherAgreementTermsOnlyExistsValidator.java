...
public class OtherAgreementTermsOnlyExistsValidator implements ValidatorWithArg<OtherAgreementTerms, Set<String>> {
	...
	public <T2 extends OtherAgreementTerms> ValidationResult<OtherAgreementTerms> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("legalDocument", ExistenceChecker.isSet(o.getLegalDocument()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("OtherAgreementTerms", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("OtherAgreementTerms", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
