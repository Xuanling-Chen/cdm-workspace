...
public class AssetPoolMeta implements RosettaMetaData<AssetPool> {
	...
	@Override
	public List<Validator<? super AssetPool>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AssetPool> validator() {
		return new cdm.base.staticdata.asset.common.validation.AssetPoolValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AssetPool, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.AssetPoolOnlyExistsValidator();
	}
}
