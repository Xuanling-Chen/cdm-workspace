...
public class AssetTypeOnlyExistsValidator implements ValidatorWithArg<AssetType, Set<String>> {
	...
	public <T2 extends AssetType> ValidationResult<AssetType> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("assetType", ExistenceChecker.isSet(o.getAssetType()))
		...
		if (setFields.equals(fields)) {
			return success("AssetType", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("AssetType", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
