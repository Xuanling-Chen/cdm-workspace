...
public class SpecialPurposeVehicleIssuerTypeMeta implements RosettaMetaData<SpecialPurposeVehicleIssuerType> {
	...
	@Override
	public List<Validator<? super SpecialPurposeVehicleIssuerType>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super SpecialPurposeVehicleIssuerType> validator() {
		return new cdm.base.staticdata.asset.common.validation.SpecialPurposeVehicleIssuerTypeValidator();
	}
	
	@Override
	public ValidatorWithArg<? super SpecialPurposeVehicleIssuerType, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.SpecialPurposeVehicleIssuerTypeOnlyExistsValidator();
	}
}
