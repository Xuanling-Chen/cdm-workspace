...
public class CommodityReferenceFrameworkOnlyExistsValidator implements ValidatorWithArg<CommodityReferenceFramework, Set<String>> {
	...
	public <T2 extends CommodityReferenceFramework> ValidationResult<CommodityReferenceFramework> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("commodityBase", ExistenceChecker.isSet(o.getCommodityBase()))
				.put("subCommodity", ExistenceChecker.isSet(o.getSubCommodity()))
				.put("commodityName", ExistenceChecker.isSet(o.getCommodityName()))
		...
		if (setFields.equals(fields)) {
			return success("CommodityReferenceFramework", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("CommodityReferenceFramework", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
