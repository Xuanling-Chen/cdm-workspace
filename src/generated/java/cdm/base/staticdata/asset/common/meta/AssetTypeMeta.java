...
public class AssetTypeMeta implements RosettaMetaData<AssetType> {
	...
	@Override
	public List<Validator<? super AssetType>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AssetType> validator() {
		return new cdm.base.staticdata.asset.common.validation.AssetTypeValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AssetType, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.AssetTypeOnlyExistsValidator();
	}
}
