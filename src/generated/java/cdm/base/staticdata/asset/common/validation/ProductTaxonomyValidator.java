...
public class ProductTaxonomyValidator implements Validator<ProductTaxonomy> {
	...
	public ValidationResult<ProductTaxonomy> validate(RosettaPath path, ProductTaxonomy o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("ProductTaxonomy", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("ProductTaxonomy", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
