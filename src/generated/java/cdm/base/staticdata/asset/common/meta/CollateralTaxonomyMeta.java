...
public class CollateralTaxonomyMeta implements RosettaMetaData<CollateralTaxonomy> {
	...
	@Override
	public List<Validator<? super CollateralTaxonomy>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CollateralTaxonomy> validator() {
		return new cdm.base.staticdata.asset.common.validation.CollateralTaxonomyValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CollateralTaxonomy, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.CollateralTaxonomyOnlyExistsValidator();
	}
}
