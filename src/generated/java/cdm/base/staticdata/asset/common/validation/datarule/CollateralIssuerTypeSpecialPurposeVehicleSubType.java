...
public class CollateralIssuerTypeSpecialPurposeVehicleSubType implements Validator<CollateralIssuerType> {
	
	private static final String NAME = "CollateralIssuerTypeSpecialPurposeVehicleSubType";
	private static final String DEFINITION = "if issuerType <> IssuerTypeEnum -> SpecialPurposeVehicle then specialPurposeVehicleType is absent";
	...
	private ComparisonResult ruleIsApplicable(CollateralIssuerType collateralIssuerType) {
		try {
			return notEqual(MapperS.of(collateralIssuerType).<IssuerTypeEnum>map("getIssuerType", _collateralIssuerType -> _collateralIssuerType.getIssuerType()), MapperS.of(IssuerTypeEnum.SPECIAL_PURPOSE_VEHICLE), CardinalityOperator.Any);
		}
