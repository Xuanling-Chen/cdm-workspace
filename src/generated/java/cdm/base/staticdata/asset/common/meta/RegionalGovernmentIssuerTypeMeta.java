...
public class RegionalGovernmentIssuerTypeMeta implements RosettaMetaData<RegionalGovernmentIssuerType> {
	...
	@Override
	public List<Validator<? super RegionalGovernmentIssuerType>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super RegionalGovernmentIssuerType> validator() {
		return new cdm.base.staticdata.asset.common.validation.RegionalGovernmentIssuerTypeValidator();
	}
	
	@Override
	public ValidatorWithArg<? super RegionalGovernmentIssuerType, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.RegionalGovernmentIssuerTypeOnlyExistsValidator();
	}
}
