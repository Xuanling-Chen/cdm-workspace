...
public class IndexMeta implements RosettaMetaData<Index> {
	...
	@Override
	public List<Validator<? super Index>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Index> validator() {
		return new cdm.base.staticdata.asset.common.validation.IndexValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Index, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.IndexOnlyExistsValidator();
	}
}
