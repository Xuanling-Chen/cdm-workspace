...
public class ConvertibleBondMeta implements RosettaMetaData<ConvertibleBond> {
	...
	@Override
	public List<Validator<? super ConvertibleBond>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ConvertibleBond> validator() {
		return new cdm.base.staticdata.asset.common.validation.ConvertibleBondValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ConvertibleBond, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.ConvertibleBondOnlyExistsValidator();
	}
}
