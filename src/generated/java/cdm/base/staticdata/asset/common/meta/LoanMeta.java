...
public class LoanMeta implements RosettaMetaData<Loan> {
	...
	@Override
	public List<Validator<? super Loan>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Loan> validator() {
		return new cdm.base.staticdata.asset.common.validation.LoanValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Loan, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.LoanOnlyExistsValidator();
	}
}
