...
public class EquityMeta implements RosettaMetaData<Equity> {
	...
	@Override
	public List<Validator<? super Equity>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Equity> validator() {
		return new cdm.base.staticdata.asset.common.validation.EquityValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Equity, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.EquityOnlyExistsValidator();
	}
}
