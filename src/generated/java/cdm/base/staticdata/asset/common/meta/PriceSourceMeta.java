...
public class PriceSourceMeta implements RosettaMetaData<PriceSource> {
	...
	@Override
	public List<Validator<? super PriceSource>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PriceSource> validator() {
		return new cdm.base.staticdata.asset.common.validation.PriceSourceValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PriceSource, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.PriceSourceOnlyExistsValidator();
	}
}
