...
public class IdentifiedProductMeta implements RosettaMetaData<IdentifiedProduct> {
	...
	@Override
	public List<Validator<? super IdentifiedProduct>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super IdentifiedProduct> validator() {
		return new cdm.base.staticdata.asset.common.validation.IdentifiedProductValidator();
	}
	
	@Override
	public ValidatorWithArg<? super IdentifiedProduct, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.IdentifiedProductOnlyExistsValidator();
	}
}
