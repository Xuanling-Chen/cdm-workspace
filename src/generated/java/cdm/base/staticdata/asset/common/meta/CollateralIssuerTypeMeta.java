...
public class CollateralIssuerTypeMeta implements RosettaMetaData<CollateralIssuerType> {
	...
	@Override
	public List<Validator<? super CollateralIssuerType>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CollateralIssuerType> validator() {
		return new cdm.base.staticdata.asset.common.validation.CollateralIssuerTypeValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CollateralIssuerType, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.CollateralIssuerTypeOnlyExistsValidator();
	}
}
