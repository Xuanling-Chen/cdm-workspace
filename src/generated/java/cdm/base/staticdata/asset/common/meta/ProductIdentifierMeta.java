...
public class ProductIdentifierMeta implements RosettaMetaData<ProductIdentifier> {
	...
	@Override
	public List<Validator<? super ProductIdentifier>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ProductIdentifier> validator() {
		return new cdm.base.staticdata.asset.common.validation.ProductIdentifierValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ProductIdentifier, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.ProductIdentifierOnlyExistsValidator();
	}
}
