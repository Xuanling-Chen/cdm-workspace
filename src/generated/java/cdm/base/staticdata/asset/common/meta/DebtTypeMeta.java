...
public class DebtTypeMeta implements RosettaMetaData<DebtType> {
	...
	@Override
	public List<Validator<? super DebtType>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super DebtType> validator() {
		return new cdm.base.staticdata.asset.common.validation.DebtTypeValidator();
	}
	
	@Override
	public ValidatorWithArg<? super DebtType, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.common.validation.exists.DebtTypeOnlyExistsValidator();
	}
}
