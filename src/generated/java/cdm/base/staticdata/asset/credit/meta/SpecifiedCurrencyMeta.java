...
public class SpecifiedCurrencyMeta implements RosettaMetaData<SpecifiedCurrency> {
	...
	@Override
	public List<Validator<? super SpecifiedCurrency>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super SpecifiedCurrency> validator() {
		return new cdm.base.staticdata.asset.credit.validation.SpecifiedCurrencyValidator();
	}
	
	@Override
	public ValidatorWithArg<? super SpecifiedCurrency, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.asset.credit.validation.exists.SpecifiedCurrencyOnlyExistsValidator();
	}
}
