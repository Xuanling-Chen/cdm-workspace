...
public class NotDomesticCurrencyValidator implements Validator<NotDomesticCurrency> {
	...
	public ValidationResult<NotDomesticCurrency> validate(RosettaPath path, NotDomesticCurrency o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("NotDomesticCurrency", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("NotDomesticCurrency", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
