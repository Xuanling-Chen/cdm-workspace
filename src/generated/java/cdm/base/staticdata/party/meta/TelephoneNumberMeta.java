...
public class TelephoneNumberMeta implements RosettaMetaData<TelephoneNumber> {
	...
	@Override
	public List<Validator<? super TelephoneNumber>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super TelephoneNumber> validator() {
		return new cdm.base.staticdata.party.validation.TelephoneNumberValidator();
	}
	
	@Override
	public ValidatorWithArg<? super TelephoneNumber, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.TelephoneNumberOnlyExistsValidator();
	}
}
