...
public class AncillaryPartyMeta implements RosettaMetaData<AncillaryParty> {
	...
	@Override
	public List<Validator<? super AncillaryParty>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super AncillaryParty> validator() {
		return new cdm.base.staticdata.party.validation.AncillaryPartyValidator();
	}
	
	@Override
	public ValidatorWithArg<? super AncillaryParty, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.AncillaryPartyOnlyExistsValidator();
	}
}
