...
public class NaturalPersonMeta implements RosettaMetaData<NaturalPerson> {
	...
	@Override
	public List<Validator<? super NaturalPerson>> choiceRuleValidators() {
		return Arrays.asList(
			new cdm.base.staticdata.party.validation.choicerule.NaturalPersonNaturalPersonChoice()
		);
	}
	...
	public Validator<? super NaturalPerson> validator() {
		return new cdm.base.staticdata.party.validation.NaturalPersonValidator();
	}
	
	@Override
	public ValidatorWithArg<? super NaturalPerson, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.NaturalPersonOnlyExistsValidator();
	}
}
