...
public class BusinessUnitMeta implements RosettaMetaData<BusinessUnit> {
	...
	@Override
	public List<Validator<? super BusinessUnit>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super BusinessUnit> validator() {
		return new cdm.base.staticdata.party.validation.BusinessUnitValidator();
	}
	
	@Override
	public ValidatorWithArg<? super BusinessUnit, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.BusinessUnitOnlyExistsValidator();
	}
}
