...
public class BuyerSellerMeta implements RosettaMetaData<BuyerSeller> {
	...
	@Override
	public List<Validator<? super BuyerSeller>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super BuyerSeller> validator() {
		return new cdm.base.staticdata.party.validation.BuyerSellerValidator();
	}
	
	@Override
	public ValidatorWithArg<? super BuyerSeller, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.BuyerSellerOnlyExistsValidator();
	}
}
