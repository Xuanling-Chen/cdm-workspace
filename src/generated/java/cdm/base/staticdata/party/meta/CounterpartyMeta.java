...
public class CounterpartyMeta implements RosettaMetaData<Counterparty> {
	...
	@Override
	public List<Validator<? super Counterparty>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Counterparty> validator() {
		return new cdm.base.staticdata.party.validation.CounterpartyValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Counterparty, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.CounterpartyOnlyExistsValidator();
	}
}
