...
public class ContactInformationMeta implements RosettaMetaData<ContactInformation> {
	...
	@Override
	public List<Validator<? super ContactInformation>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ContactInformation> validator() {
		return new cdm.base.staticdata.party.validation.ContactInformationValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ContactInformation, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.ContactInformationOnlyExistsValidator();
	}
}
