...
public class ReferenceBanksMeta implements RosettaMetaData<ReferenceBanks> {
	...
	@Override
	public List<Validator<? super ReferenceBanks>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super ReferenceBanks> validator() {
		return new cdm.base.staticdata.party.validation.ReferenceBanksValidator();
	}
	
	@Override
	public ValidatorWithArg<? super ReferenceBanks, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.ReferenceBanksOnlyExistsValidator();
	}
}
