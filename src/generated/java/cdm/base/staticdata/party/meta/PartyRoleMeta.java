...
public class PartyRoleMeta implements RosettaMetaData<PartyRole> {
	...
	@Override
	public List<Validator<? super PartyRole>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PartyRole> validator() {
		return new cdm.base.staticdata.party.validation.PartyRoleValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PartyRole, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.PartyRoleOnlyExistsValidator();
	}
}
