...
public class AddressMeta implements RosettaMetaData<Address> {
	...
	@Override
	public List<Validator<? super Address>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Address> validator() {
		return new cdm.base.staticdata.party.validation.AddressValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Address, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.AddressOnlyExistsValidator();
	}
}
