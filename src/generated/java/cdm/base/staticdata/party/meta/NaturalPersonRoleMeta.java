...
public class NaturalPersonRoleMeta implements RosettaMetaData<NaturalPersonRole> {
	...
	@Override
	public List<Validator<? super NaturalPersonRole>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super NaturalPersonRole> validator() {
		return new cdm.base.staticdata.party.validation.NaturalPersonRoleValidator();
	}
	
	@Override
	public ValidatorWithArg<? super NaturalPersonRole, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.NaturalPersonRoleOnlyExistsValidator();
	}
}
