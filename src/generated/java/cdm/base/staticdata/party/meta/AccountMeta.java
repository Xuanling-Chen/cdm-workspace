...
public class AccountMeta implements RosettaMetaData<Account> {
	...
	@Override
	public List<Validator<? super Account>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Account> validator() {
		return new cdm.base.staticdata.party.validation.AccountValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Account, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.AccountOnlyExistsValidator();
	}
}
