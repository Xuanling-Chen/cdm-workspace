...
public class PartyReferencePayerReceiverMeta implements RosettaMetaData<PartyReferencePayerReceiver> {
	...
	@Override
	public List<Validator<? super PartyReferencePayerReceiver>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PartyReferencePayerReceiver> validator() {
		return new cdm.base.staticdata.party.validation.PartyReferencePayerReceiverValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PartyReferencePayerReceiver, Set<String>> onlyExistsValidator() {
		return new cdm.base.staticdata.party.validation.exists.PartyReferencePayerReceiverOnlyExistsValidator();
	}
}
