...
public class BusinessUnitValidator implements Validator<BusinessUnit> {
	...
	public ValidationResult<BusinessUnit> validate(RosettaPath path, BusinessUnit o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("BusinessUnit", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("BusinessUnit", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
