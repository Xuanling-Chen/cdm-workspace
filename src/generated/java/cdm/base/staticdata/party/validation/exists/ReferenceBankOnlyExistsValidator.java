...
public class ReferenceBankOnlyExistsValidator implements ValidatorWithArg<ReferenceBank, Set<String>> {
	...
	public <T2 extends ReferenceBank> ValidationResult<ReferenceBank> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("referenceBankId", ExistenceChecker.isSet(o.getReferenceBankId()))
				.put("referenceBankName", ExistenceChecker.isSet(o.getReferenceBankName()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("ReferenceBank", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("ReferenceBank", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
