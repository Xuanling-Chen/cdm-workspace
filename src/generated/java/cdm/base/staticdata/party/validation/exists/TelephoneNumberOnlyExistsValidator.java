...
public class TelephoneNumberOnlyExistsValidator implements ValidatorWithArg<TelephoneNumber, Set<String>> {
	...
	public <T2 extends TelephoneNumber> ValidationResult<TelephoneNumber> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("telephoneNumberType", ExistenceChecker.isSet(o.getTelephoneNumberType()))
				.put("number", ExistenceChecker.isSet(o.getNumber()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("TelephoneNumber", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("TelephoneNumber", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
