...
public class LegalEntityOnlyExistsValidator implements ValidatorWithArg<LegalEntity, Set<String>> {
	...
	public <T2 extends LegalEntity> ValidationResult<LegalEntity> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("entityId", ExistenceChecker.isSet(o.getEntityId()))
		...
		if (setFields.equals(fields)) {
			return success("LegalEntity", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("LegalEntity", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
