...
public class AncillaryEntityOnlyExistsValidator implements ValidatorWithArg<AncillaryEntity, Set<String>> {
	...
	public <T2 extends AncillaryEntity> ValidationResult<AncillaryEntity> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("legalEntity", ExistenceChecker.isSet(o.getLegalEntity()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AncillaryEntity", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("AncillaryEntity", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
