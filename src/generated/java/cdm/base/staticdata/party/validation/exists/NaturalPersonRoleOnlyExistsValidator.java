...
public class NaturalPersonRoleOnlyExistsValidator implements ValidatorWithArg<NaturalPersonRole, Set<String>> {
	...
	public <T2 extends NaturalPersonRole> ValidationResult<NaturalPersonRole> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("personReference", ExistenceChecker.isSet(o.getPersonReference()))
		...
		if (setFields.equals(fields)) {
			return success("NaturalPersonRole", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("NaturalPersonRole", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
