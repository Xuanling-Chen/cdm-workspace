...
public class PartyOnlyExistsValidator implements ValidatorWithArg<Party, Set<String>> {
	...
	public <T2 extends Party> ValidationResult<Party> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("partyId", ExistenceChecker.isSet(o.getPartyId()))
		...
		if (setFields.equals(fields)) {
			return success("Party", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("Party", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
