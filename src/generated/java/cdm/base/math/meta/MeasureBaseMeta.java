...
public class MeasureBaseMeta implements RosettaMetaData<MeasureBase> {
	...
	@Override
	public List<Validator<? super MeasureBase>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super MeasureBase> validator() {
		return new cdm.base.math.validation.MeasureBaseValidator();
	}
	
	@Override
	public ValidatorWithArg<? super MeasureBase, Set<String>> onlyExistsValidator() {
		return new cdm.base.math.validation.exists.MeasureBaseOnlyExistsValidator();
	}
}
