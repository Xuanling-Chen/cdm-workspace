...
public class NonNegativeStepMeta implements RosettaMetaData<NonNegativeStep> {
	...
	@Override
	public List<Validator<? super NonNegativeStep>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super NonNegativeStep> validator() {
		return new cdm.base.math.validation.NonNegativeStepValidator();
	}
	
	@Override
	public ValidatorWithArg<? super NonNegativeStep, Set<String>> onlyExistsValidator() {
		return new cdm.base.math.validation.exists.NonNegativeStepOnlyExistsValidator();
	}
}
