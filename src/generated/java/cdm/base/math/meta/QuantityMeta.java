...
public class QuantityMeta implements RosettaMetaData<Quantity> {
	...
	public List<Validator<? super Quantity>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.create(cdm.base.math.validation.datarule.QuantityQuantityMultiplier.class)
		);
	}

	@Override
	public List<Validator<? super Quantity>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Quantity> validator() {
		return new cdm.base.math.validation.QuantityValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Quantity, Set<String>> onlyExistsValidator() {
		return new cdm.base.math.validation.exists.QuantityOnlyExistsValidator();
	}
}
