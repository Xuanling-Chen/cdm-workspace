...
public class ScheduleMeta implements RosettaMetaData<Schedule> {
	...
	@Override
	public List<Validator<? super Schedule>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super Schedule> validator() {
		return new cdm.base.math.validation.ScheduleValidator();
	}
	
	@Override
	public ValidatorWithArg<? super Schedule, Set<String>> onlyExistsValidator() {
		return new cdm.base.math.validation.exists.ScheduleOnlyExistsValidator();
	}
}
