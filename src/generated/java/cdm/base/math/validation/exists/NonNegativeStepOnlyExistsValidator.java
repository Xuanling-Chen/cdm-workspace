...
public class NonNegativeStepOnlyExistsValidator implements ValidatorWithArg<NonNegativeStep, Set<String>> {
	...
	public <T2 extends NonNegativeStep> ValidationResult<NonNegativeStep> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("stepDate", ExistenceChecker.isSet(o.getStepDate()))
				.put("stepValue", ExistenceChecker.isSet(o.getStepValue()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("NonNegativeStep", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("NonNegativeStep", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
