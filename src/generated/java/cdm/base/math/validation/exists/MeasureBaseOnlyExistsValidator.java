...
public class MeasureBaseOnlyExistsValidator implements ValidatorWithArg<MeasureBase, Set<String>> {
	...
	public <T2 extends MeasureBase> ValidationResult<MeasureBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("unitOfAmount", ExistenceChecker.isSet(o.getUnitOfAmount()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("MeasureBase", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("MeasureBase", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
