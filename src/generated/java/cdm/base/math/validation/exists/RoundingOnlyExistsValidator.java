...
public class RoundingOnlyExistsValidator implements ValidatorWithArg<Rounding, Set<String>> {
	...
	public <T2 extends Rounding> ValidationResult<Rounding> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("roundingDirection", ExistenceChecker.isSet(o.getRoundingDirection()))
		...
		if (setFields.equals(fields)) {
			return success("Rounding", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("Rounding", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
