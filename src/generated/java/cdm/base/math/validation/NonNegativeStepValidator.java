...
public class NonNegativeStepValidator implements Validator<NonNegativeStep> {
	...
	public ValidationResult<NonNegativeStep> validate(RosettaPath path, NonNegativeStep o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("NonNegativeStep", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("NonNegativeStep", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
