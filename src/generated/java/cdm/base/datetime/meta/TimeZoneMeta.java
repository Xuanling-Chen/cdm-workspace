...
public class TimeZoneMeta implements RosettaMetaData<TimeZone> {
	...
	@Override
	public List<Validator<? super TimeZone>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super TimeZone> validator() {
		return new cdm.base.datetime.validation.TimeZoneValidator();
	}
	
	@Override
	public ValidatorWithArg<? super TimeZone, Set<String>> onlyExistsValidator() {
		return new cdm.base.datetime.validation.exists.TimeZoneOnlyExistsValidator();
	}
}
