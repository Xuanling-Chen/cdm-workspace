...
public class DateListMeta implements RosettaMetaData<DateList> {
	...
	@Override
	public List<Validator<? super DateList>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super DateList> validator() {
		return new cdm.base.datetime.validation.DateListValidator();
	}
	
	@Override
	public ValidatorWithArg<? super DateList, Set<String>> onlyExistsValidator() {
		return new cdm.base.datetime.validation.exists.DateListOnlyExistsValidator();
	}
}
