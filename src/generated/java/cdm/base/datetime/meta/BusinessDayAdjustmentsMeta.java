...
public class BusinessDayAdjustmentsMeta implements RosettaMetaData<BusinessDayAdjustments> {
	...
	@Override
	public List<Validator<? super BusinessDayAdjustments>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super BusinessDayAdjustments> validator() {
		return new cdm.base.datetime.validation.BusinessDayAdjustmentsValidator();
	}
	
	@Override
	public ValidatorWithArg<? super BusinessDayAdjustments, Set<String>> onlyExistsValidator() {
		return new cdm.base.datetime.validation.exists.BusinessDayAdjustmentsOnlyExistsValidator();
	}
}
