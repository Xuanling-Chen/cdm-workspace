...
public class DateTimeListMeta implements RosettaMetaData<DateTimeList> {
	...
	@Override
	public List<Validator<? super DateTimeList>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super DateTimeList> validator() {
		return new cdm.base.datetime.validation.DateTimeListValidator();
	}
	
	@Override
	public ValidatorWithArg<? super DateTimeList, Set<String>> onlyExistsValidator() {
		return new cdm.base.datetime.validation.exists.DateTimeListOnlyExistsValidator();
	}
}
