...
public class PeriodBoundMeta implements RosettaMetaData<PeriodBound> {
	...
	@Override
	public List<Validator<? super PeriodBound>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super PeriodBound> validator() {
		return new cdm.base.datetime.validation.PeriodBoundValidator();
	}
	
	@Override
	public ValidatorWithArg<? super PeriodBound, Set<String>> onlyExistsValidator() {
		return new cdm.base.datetime.validation.exists.PeriodBoundOnlyExistsValidator();
	}
}
