...
public class RelativeDatesMeta implements RosettaMetaData<RelativeDates> {
	...
	@Override
	public List<Validator<? super RelativeDates>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super RelativeDates> validator() {
		return new cdm.base.datetime.validation.RelativeDatesValidator();
	}
	
	@Override
	public ValidatorWithArg<? super RelativeDates, Set<String>> onlyExistsValidator() {
		return new cdm.base.datetime.validation.exists.RelativeDatesOnlyExistsValidator();
	}
}
