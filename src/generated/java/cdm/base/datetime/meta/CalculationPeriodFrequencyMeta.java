...
public class CalculationPeriodFrequencyMeta implements RosettaMetaData<CalculationPeriodFrequency> {
	...
	@Override
	public List<Validator<? super CalculationPeriodFrequency>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super CalculationPeriodFrequency> validator() {
		return new cdm.base.datetime.validation.CalculationPeriodFrequencyValidator();
	}
	
	@Override
	public ValidatorWithArg<? super CalculationPeriodFrequency, Set<String>> onlyExistsValidator() {
		return new cdm.base.datetime.validation.exists.CalculationPeriodFrequencyOnlyExistsValidator();
	}
}
