...
public class BusinessCenterTimeMeta implements RosettaMetaData<BusinessCenterTime> {
	...
	@Override
	public List<Validator<? super BusinessCenterTime>> choiceRuleValidators() {
		return Arrays.asList(
		);
	}
	...
	public Validator<? super BusinessCenterTime> validator() {
		return new cdm.base.datetime.validation.BusinessCenterTimeValidator();
	}
	
	@Override
	public ValidatorWithArg<? super BusinessCenterTime, Set<String>> onlyExistsValidator() {
		return new cdm.base.datetime.validation.exists.BusinessCenterTimeOnlyExistsValidator();
	}
}
