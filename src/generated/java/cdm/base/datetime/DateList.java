...
public interface DateList extends RosettaModelObject {
	...
	/**
	 */
	List<? extends Date> getDate();
	final static DateListMeta metaData = new DateListMeta();
	...
	interface DateListBuilder extends DateList, RosettaModelObjectBuilder {
		...
		DateList.DateListBuilder addDate(Date date, int _idx);
		DateList.DateListBuilder addDate(List<? extends Date> date);
		DateList.DateListBuilder setDate(List<? extends Date> date);
	...
	//DateList.DateListImpl
	class DateListImpl implements DateList {
		private final List<? extends Date> date;
		...
		@Override
		public List<? extends Date> getDate() {
			return date;
		}
