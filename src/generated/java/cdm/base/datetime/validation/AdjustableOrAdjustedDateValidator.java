...
public class AdjustableOrAdjustedDateValidator implements Validator<AdjustableOrAdjustedDate> {
	...
	public ValidationResult<AdjustableOrAdjustedDate> validate(RosettaPath path, AdjustableOrAdjustedDate o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AdjustableOrAdjustedDate", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("AdjustableOrAdjustedDate", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
