...
public class PeriodValidator implements Validator<Period> {
	...
	public ValidationResult<Period> validate(RosettaPath path, Period o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("Period", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("Period", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
