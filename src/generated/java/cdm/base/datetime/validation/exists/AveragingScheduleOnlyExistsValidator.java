...
public class AveragingScheduleOnlyExistsValidator implements ValidatorWithArg<AveragingSchedule, Set<String>> {
	...
	public <T2 extends AveragingSchedule> ValidationResult<AveragingSchedule> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("averagingPeriodFrequency", ExistenceChecker.isSet(o.getAveragingPeriodFrequency()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AveragingSchedule", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("AveragingSchedule", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
