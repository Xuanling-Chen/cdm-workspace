...
public class TimeZoneOnlyExistsValidator implements ValidatorWithArg<TimeZone, Set<String>> {
	...
	public <T2 extends TimeZone> ValidationResult<TimeZone> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("location", ExistenceChecker.isSet(o.getLocation()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("TimeZone", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("TimeZone", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
