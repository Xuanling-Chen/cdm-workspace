...
public class BusinessCenterTimeOnlyExistsValidator implements ValidatorWithArg<BusinessCenterTime, Set<String>> {
	...
	public <T2 extends BusinessCenterTime> ValidationResult<BusinessCenterTime> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("hourMinuteTime", ExistenceChecker.isSet(o.getHourMinuteTime()))
		...
		if (setFields.equals(fields)) {
			return success("BusinessCenterTime", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("BusinessCenterTime", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
