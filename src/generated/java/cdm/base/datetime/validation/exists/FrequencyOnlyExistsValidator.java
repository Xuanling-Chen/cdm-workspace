...
public class FrequencyOnlyExistsValidator implements ValidatorWithArg<Frequency, Set<String>> {
	...
	public <T2 extends Frequency> ValidationResult<Frequency> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("periodMultiplier", ExistenceChecker.isSet(o.getPeriodMultiplier()))
		...
		if (setFields.equals(fields)) {
			return success("Frequency", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("Frequency", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
