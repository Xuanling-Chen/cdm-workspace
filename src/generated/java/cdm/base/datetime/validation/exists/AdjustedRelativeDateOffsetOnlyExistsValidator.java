...
public class AdjustedRelativeDateOffsetOnlyExistsValidator implements ValidatorWithArg<AdjustedRelativeDateOffset, Set<String>> {
	...
	public <T2 extends AdjustedRelativeDateOffset> ValidationResult<AdjustedRelativeDateOffset> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("relativeDateAdjustments", ExistenceChecker.isSet(o.getRelativeDateAdjustments()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AdjustedRelativeDateOffset", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("AdjustedRelativeDateOffset", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
