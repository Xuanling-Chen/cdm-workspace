...
public class PeriodBoundOnlyExistsValidator implements ValidatorWithArg<PeriodBound, Set<String>> {
	...
	public <T2 extends PeriodBound> ValidationResult<PeriodBound> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("inclusive", ExistenceChecker.isSet(o.getInclusive()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("PeriodBound", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "");
		}
		return failure("PeriodBound", ValidationType.ONLY_EXISTS, o.getClass().getSimpleName(), path, "",
