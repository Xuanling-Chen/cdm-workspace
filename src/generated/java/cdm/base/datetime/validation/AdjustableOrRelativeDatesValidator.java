...
public class AdjustableOrRelativeDatesValidator implements Validator<AdjustableOrRelativeDates> {
	...
	public ValidationResult<AdjustableOrRelativeDates> validate(RosettaPath path, AdjustableOrRelativeDates o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AdjustableOrRelativeDates", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "", error);
		}
		return success("AdjustableOrRelativeDates", ValidationType.MODEL_INSTANCE, o.getClass().getSimpleName(), path, "");
	}
